...
RevenueCat authenticates requests from the [REST API](https://docs.revenuecat.com/docs/api-v2) and the RevenueCat SDK using your app's API keys. All requests must include a valid API key. There are also two types of API keys: public and secret.
