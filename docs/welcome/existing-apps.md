...
<a class="cta" href="/docs/migrating-existing-subscriptions" target="_self">Start Your Migration Plan →</a>
...
<a class="cta" href="/docs/integrations" target="_self">Set up Events →</a>
