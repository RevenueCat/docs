...
![An example of how products in Apple, Google, and Stripe translate to Products, Entitlements, and Offerings in RevenueCat.](https://files.readme.io/fb06e40-Screen_Shot_2020-07-01_at_6.12.53_PM.png)
...
- **[iOS / App Store Connect ](/docs/getting-started/entitlements/ios-products)**
- **[Android / Google Play Console ](/docs/getting-started/entitlements/android-products)**
- **[Android / Amazon Appstore ](/docs/getting-started/entitlements/amazon-product-setup)**
- **[Stripe ](/docs/getting-started/entitlements/stripe-products)**
...
![Example Entitlement structure with associated Apple, Google, Stripe, or Amazon product identifiers.](https://files.readme.io/5bb6bc2-Screen_Shot_2020-07-01_at_6.14.38_PM.png "Screen Shot 2020-07-01 at 6.14.38 PM.png")
...
For Google Play store products, if you select a non backwards-compatible product and the [app compatibility setting](/docs/getting-started/entitlements/google-subscriptions-and-backwards-compatibility) is set to "SDK v6+ and backwards compatible", you will have the ability to configure a backwards compatible fallback product. This product will be available for purchase in previous versions of the SDK which don't yet support non backwards compatible products.
...
Continue on to [Displaying Products](/docs/getting-started/displaying-products) to start showing your new Offering in your app.
