...
- **[iOS / App Store Connect ](/docs/ios-products)**
- **[Android / Google Play Console ](/docs/android-products)**
- **[Android / Amazon Appstore ](/docs/amazon-product-setup)**
- **[Stripe ](/docs/stripe-products)**
...
For Google Play store products, if you select a non backwards-compatible product and the [app compatibility setting](/docs/google-subscriptions-and-backwards-compatibility) is set to "SDK v6+ and backwards compatible", you will have the ability to configure a backwards compatible fallback product. This product will be available for purchase in previous versions of the SDK which don't yet support non backwards compatible products.
...
Continue on to [Displaying Products](/docs/displaying-products) to start showing your new Offering in your app.
