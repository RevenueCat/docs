...
- **[iOS / App Store Connect ](/ios-products)**
- **[Android / Google Play Console ](/android-products)**
- **[Android / Amazon Appstore ](/amazon-product-setup)**
...
![](/images/0b9a2f4-app.revenuecat.com_projects_3310b6dd_entitlements_2_7429e4d6cdaab6f86949cfcf0f3a2d5e.png "app.revenuecat.com_projects_3310b6dd_entitlements (2).png")
...
For Google Play store products, if you select a non backwards-compatible product and the [app compatibility setting](/google-subscriptions-and-backwards-compatibility) is set to "SDK v6+ and backwards compatible", you will have the ability to configure a backwards compatible fallback product. This product will be available for purchase in previous versions of the SDK which don't yet support non backwards compatible products.
...
Continue on to [Displaying Products](/displaying-products) to start showing your new Offering in your app.
