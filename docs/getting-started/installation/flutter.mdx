...
If you plan to use [RevenueCat Paywalls](/docs/tools/paywalls-v2), your `MainActivity` needs to subclass `FlutterFragmentActivity` instead of `FlutterActivity`.

import flutterMainActivity from "!!raw-loader!@site/code_blocks/getting-started/installation/flutter_mainactivity.dart";
