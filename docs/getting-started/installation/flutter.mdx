...
* Now that you've installed the Purchases SDK in Flutter, get started by [configuring an instance of Purchases ➡️](/getting-started/getting-started#4-using-revenuecats-purchases-sdk)