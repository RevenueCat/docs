...
That's it! [You can skip ahead to importing the framework](/docs/reactnative#import-purchases)
...
:::info
If you choose to install the framework via [CocoaPods](ios#section-install-via-cocoapods), you can skip ahead to [importing the framework](/docs/reactnative#import-purchases)
:::
...
* Now that you've installed the Purchases SDK in your React Native app, get started by [initializing an instance of Purchases :fa-arrow-right:](/docs/getting-started#4-using-revenuecats-purchases-sdk)