...
- Now that you've installed the Purchases SDK in your Android app, get started by [configuring an instance of Purchases ](/quickstart#4-using-revenuecats-purchases-sdk)