...
<RCCodeBlock tabs={[
    { type: 'groovy', content: content, name: 'Groovy' }
]} />
...
<RCCodeBlock tabs={[
    { type: 'groovy', content: unityContent, name: 'Groovy' }
]} />
...
- Now that you've installed the Purchases SDK in your Android app, get started by [configuring an instance of Purchases ](/docs/getting-started/getting-started#4-using-revenuecats-purchases-sdk)