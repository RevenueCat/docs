...
3. Enter your app's name. Navigate to the [Roku Pay Web Services page](https://developer.roku.com/rpay-web-services) to copy your the Roku Pay API key and paste this to the RevenueCat dashboard under 'Roku Pay API Key'
