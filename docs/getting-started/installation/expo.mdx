...
An entitlement represents a level of access, features, or content that a customer is "entitled" to. When customers purchase a product, they're granted an entitlement. Create an entitlement [here](/getting-started/entitlements). Then, [attach your products](/docs/getting-started/entitlements#attaching-products-to-entitlements) to your new entitlement.

#### Create an Offering

An offering is a collection of products that are "offered" to your customers on your paywall. Create an offering for your products [here](/offerings/offerings/overview).
...
Then, [check the customer's subscription status](/customers/customer-info) by fetching the [CustomerInfo object](/customers/customer-info#:~:text=CustomerInfo%20Reference):
