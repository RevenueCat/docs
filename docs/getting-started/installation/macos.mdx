...
* Now that you've installed the Purchases SDK in your macOS app, get started by [configuring an instance of Purchases ➡️](/getting-started/quickstart#4-using-revenuecats-purchases-sdk)