...
import macosPodfileContent from "@site/code_blocks/getting-started/installation/macos_1.ruby?raw";

<RCCodeBlock
  tabs={[{ type: "ruby", content: macosPodfileContent, name: "Podfile" }]}
/>

Alternatively, pin to a specific minor version (e.g. 3.10):

import macosRubyContent from "@site/code_blocks/getting-started/installation/macos_2.ruby?raw";

<RCCodeBlock
  tabs={[{ type: "ruby", content: macosRubyContent, name: "Ruby" }]}
/>

And then run:

import macosTerminalContent from "@site/code_blocks/getting-started/installation/macos_3.ruby?raw";

<RCCodeBlock
  tabs={[{ type: "ruby", content: macosTerminalContent, name: "Terminal" }]}
/>
...
import macosSwiftContent from "@site/code_blocks/getting-started/installation/macos_4.swift?raw";
import macosObjectiveCContent from "@site/code_blocks/getting-started/installation/macos_5.m?raw";

<RCCodeBlock
  tabs={[
    { type: "swift", content: macosSwiftContent, name: "Swift" },
    {
      type: "objectivec",
      content: macosObjectiveCContent,
      name: "Objective-C",
    },
  ]}
/>
...
- Now that you've installed the Purchases SDK in your macOS app, get started by [configuring an instance of Purchases →](/getting-started/quickstart#3-using-revenuecats-purchases-sdk)
