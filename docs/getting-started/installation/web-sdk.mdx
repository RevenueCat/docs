---
title: Web SDK for RevenueCat Billing
slug: web-sdk
...
import npmContent from "!!raw-loader!@site/code_blocks/getting-started/installation/rc-billing-npm.shell";
import yarnContent from "!!raw-loader!@site/code_blocks/getting-started/installation/rc-billing-yarn.shell";
...
## Next steps
Now that you've installed the RevenueCat Web SDK, get started by [initializing it](/getting-started/configuring-sdk/web-sdk).
