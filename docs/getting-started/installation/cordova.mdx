...
The Cordova SDK will receive maintainence updates, but new RevenueCat features and new major versions will not be made available. The latest versions of this SDK use Billing Client v7, Google will not allow updates to your app after August 31st, 2026.
:::
