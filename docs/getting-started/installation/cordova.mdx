...
import cordovaTypesContent from "@site/code_blocks/getting-started/installation/ionic_typescript_cordova.txt?raw";
...
import cordovaAngularContent from "@site/code_blocks/getting-started/installation/ionic_angular_cordova.txt?raw";
...
import cordovaReactContent from "@site/code_blocks/getting-started/installation/ionic_react_cordova.txt?raw";
