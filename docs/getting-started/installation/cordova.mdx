...
* Now that you've installed the Purchases SDK in your Cordova app, get started by [initializing an instance of Purchases :fa-arrow-right:](/docs/getting-started/getting-started#4-using-revenuecats-purchases-sdk)