...
Select `File » Add Packages Dependencies... ` and enter the repository URL `https://github.com/RevenueCat/purchases-ios-spm.git` into the search bar (top right). (Note that this is a mirror of our main repository, and it will integrate far more quickly than using the main repository directly.) 
