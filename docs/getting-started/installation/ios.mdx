...
import iosPodfileContent from "@site/code_blocks/getting-started/installation/ios_1.ruby?raw";
...
import iosRubyContent from "@site/code_blocks/getting-started/installation/ios_2.ruby?raw";

<RCCodeBlock tabs={[{ type: "ruby", content: iosRubyContent, name: "Ruby" }]} />

And then run:

import iosTerminalContent from "@site/code_blocks/getting-started/installation/ios_3.ruby?raw";
...
import iosCartfileContent from "@site/code_blocks/getting-started/installation/ios_4.txt?raw";
...
import iosTextContent from "@site/code_blocks/getting-started/installation/ios_5.txt?raw";
...
import iosShellContent from "@site/code_blocks/getting-started/installation/ios_6.shell?raw";
...
import iosTextContent2 from "@site/code_blocks/getting-started/installation/ios_7.txt?raw";
...
import iosSwiftContent from "@site/code_blocks/getting-started/installation/ios_8.swift?raw";
import iosObjectiveCContent from "@site/code_blocks/getting-started/installation/ios_9.m?raw";
...
- Now that you've installed the SDK in your iOS app, get started by [configuring an instance of Purchases →](/getting-started/quickstart#3-using-revenuecats-purchases-sdk)
