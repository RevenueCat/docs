...
:::info
Already have 3.x installed? View our [migration guide to 4.x ➡️](/sdk-guides/ios-native-3x-to-4x-migration)
:::
...
<RCCodeBlock tabs={[
    { type: 'ruby', content: iosPodfileContent, name: 'Podfile' }
]} />
...
<RCCodeBlock tabs={[
    { type: 'ruby', content: iosRubyContent, name: 'Ruby' }
]} />
...
<RCCodeBlock tabs={[
    { type: 'ruby', content: iosTerminalContent, name: 'Terminal' }
]} />
...
<RCCodeBlock tabs={[
    { type: 'text', content: iosCartfileContent, name: 'Cartfile' }
]} />
...
<RCCodeBlock tabs={[
    { type: 'text', content: iosTextContent, name: 'Text' }
]} />
...
<RCCodeBlock tabs={[
    { type: 'shell', content: iosShellContent, name: 'Terminal' }
]} />
...
<RCCodeBlock tabs={[
    { type: 'text', content: iosTextContent2, name: 'Text' }
]} />
...
* Now that you've installed the SDK in your iOS app, get started by [configuring an instance of Purchases ➡️](/getting-started/quickstart#4-using-revenuecats-purchases-sdk)
