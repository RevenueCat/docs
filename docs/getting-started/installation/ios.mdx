...
RevenueCat for iOS can be installed either via [CocoaPods](/installation/ios#section-install-via-cocoapods), [Carthage](ios#section-install-via-carthage), or [Swift Package Manager](/installation/ios#section-install-via-swift-package-manager). 

:::info
Already have 3.x installed? View our [migration guide to 4.x ➡️](/ios-native-3x-to-4x-migration)
:::
...
* Now that you've installed the SDK in your iOS app, get started by [configuring an instance of Purchases ➡️](/quickstart#4-using-revenuecats-purchases-sdk)