...
Before launching your Stripe integration, be sure to read the limitations that apply to [working with web payments](/stripe#section-working-with-web-payments).
...
![](/images/9decad9-Screen_Shot_2021-12-01_at_11.25.42_AM_8ef87adc3be9481928fc48d0056b5d4c.png "Screen Shot 2021-12-01 at 11.25.42 AM.png")
...
![](/images/8154aeb-Screen_Shot_2018-12-06_at_14.26.56_38ccc6af46e3d44f82ade1c883522a12.png "Screen Shot 2018-12-06 at 14.26.56.png")
...
Add your Stripe products to your project's [entitlements](/entitlements) to easily group the products for your app. RevenueCat will send Stripe subscriptions to your app the same way we do for the other app stores.

![](/images/fd4e1ab-Screen_Shot_2021-12-01_at_11.23.21_AM_e62a0d7e6800a0a6bdf2b8e18a00d9ab.png "Screen Shot 2021-12-01 at 11.23.21 AM.png")

:::info
In order for Stripe subscriptions to unlock [entitlements](/entitlements), you must set a Product Identifier in the desired Offering to match a Stripe **product ID** exactly.
:::
...
import curlContent from "!!raw-loader!@site/code_blocks/getting-started/stripe_1.curl";
...
![](/images/bd33089-Screen_Shot_2018-12-06_at_15.43.52_6ee9aa6171a8c51c7f6a3f728e8fd434.png "Screen Shot 2018-12-06 at 15.43.52.png")
...
Pricing in RevenueCat [Charts](/charts) and [customer events](/customer-history) will reflect any coupons applied to a Stripe purchase.
:::
...
When a customer encounters an issue with their payment, RevenueCat will generate a billing issue event in the RevenueCat [Customer History](/customer-history). If all retries for a payment fails, you have three options:
