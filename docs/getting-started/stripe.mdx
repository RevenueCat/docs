...
Before launching your Stripe integration, be sure to read the limitations that apply to [working with web payments](/getting-started/stripe#section-working-with-web-payments).
