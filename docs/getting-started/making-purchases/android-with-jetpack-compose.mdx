...
import kotlinContent from "@site/code_blocks/getting-started/making-purchases/android-with-jetpack-compose_1.kt?raw";
...
import kotlinContent2 from "@site/code_blocks/getting-started/making-purchases/android-with-jetpack-compose_2.kt?raw";
