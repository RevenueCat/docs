...
You can disable [finishing transactions](/migrating-to-revenuecat/finishing-transactions) if you don't wish to have transactions finished (or consumed, in Android) automatically, but you will have to make sure that you finish/consume them yourself.
:::
