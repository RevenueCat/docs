...
* Don't forget to provide some way for customers to [restore their purchases](doc:restoring-purchases)
* With purchases coming through, make sure they're [linked to the correct app user ID](doc:user-ids)
* If you're ready to test, start with our guides on [sandbox testing](doc:sandbox)