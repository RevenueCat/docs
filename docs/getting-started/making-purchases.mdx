...
import flutterContent5 from "@site/code_blocks/getting-started/making-purchases_5.txt?raw";
import reactNativeContent6 from "@site/code_blocks/getting-started/making-purchases_6.txt?raw";
import cordovaContent7 from "@site/code_blocks/getting-started/making-purchases_7.txt?raw";
import capacitorContent8 from "@site/code_blocks/getting-started/making-purchases_capacitor.txt?raw";
