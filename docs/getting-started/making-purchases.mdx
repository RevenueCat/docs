...
If you are migrating an existing app to RevenueCat and want to continue using your own in-app purchase logic, you can disable [finishing transactions](/migrating-to-revenuecat/sdk-or-not/finishing-transactions) if you don't wish to have transactions finished (or consumed, in Android) automatically, but you will have to make sure that you finish/consume them yourself.
:::
