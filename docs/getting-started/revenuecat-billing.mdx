...
### Presenting the packages of the current offerings

We recommend using [Offerings](/getting-started/entitlements#offerings) to configure which products get presented to the customer. You can iterate over and show the packages of the current offering like this:
