...
To purchase a package, use the `purchasePackage()` method of the `Purchases` object. It returns a `Promise<{customerInfo: CustomerInfo}>` object. To handle errors, you should catch any exceptions that occur.
