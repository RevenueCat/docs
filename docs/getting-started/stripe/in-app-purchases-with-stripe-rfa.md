...
In order to have a unified view for business analytics for both web and IAP customers we recommend to use [Stripe Data Pipeline](https://stripe.com/data-pipeline) and [RevenueCat data export](/docs/integrations/scheduled-data-exports) functionality to consolidate data in a data warehouse.
...
RevenueCat has the ability to provide consolidated [charts](/docs/dashboard-and-metrics/charts) for revenue processed across app stores and on Stripe.
