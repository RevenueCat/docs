...
![Google app setting: SDK support in offering setup](https://files.readme.io/96831d2-Screenshot_2023-03-27_at_11.03.06.png)
...
![Selecting a backwards compatible fallback product](https://files.readme.io/39a73e1-Screenshot_2023-03-21_at_10.54.52.png)
...
- Update your [Play Store service credentials](/docs/service-credentials/creating-play-service-credentials) in the app's settings in RevenueCat. This will re-trigger the migration. Please allow a few minutes for the migration to complete, and then check the product status again.
