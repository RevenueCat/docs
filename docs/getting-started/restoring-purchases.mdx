...
## Considerings for enabling "Track New Purchases from Server-to-Server Notifications"
...
2. Check you are not setting `appAccountToken` or `obfuscatedExternalAccountId` fields, **or**
2. Verify that any `appAccountToken` or `obfuscatedExternalAccountId` set for your customers will match their RevenueCat app user ID.
