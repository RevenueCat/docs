...
hidden: false
---
If you've [configured Offerings](/docs/getting-started/entitlements) in RevenueCat, you can control which products are shown to users without requiring an app update. Building paywalls that are dynamic and can react to different product configurations gives you maximum flexibility to make remote updates.

![](https://files.readme.io/edbe93c-Screen_Shot_2019-09-20_at_8.42.23_AM.png "Screen Shot 2019-09-20 at 8.42.23 AM.png")

:::info
Before products and offerings can be fetched from RevenueCat, be sure to initialize the Purchases SDK by following our [Quickstart](/docs/getting-started/getting-started) guide.
:::

## Fetching Offerings

Offerings are fetched through the SDK based on their [configuration](/docs/getting-started/entitlements) in the RevenueCat dashboard.
...
<RCCodeBlock tabs={[
    { type: 'swift', content: docsTesterSwift, name: 'Swift', region: 'Displaying products' },
...
![Screenshot](https://files.readme.io/7508f4b-Screenshot_2023-12-05_at_10.17.25_PM.png)
...
<RCCodeBlock tabs={[
    { type: 'swift', content: docsTesterSwift, name: 'Swift', region: 'Custom Offering identifiers'},
...
<RCCodeBlock tabs={[
    { type: 'swift', content: docsTesterSwift, name: 'Swift', region: 'Displaying packages' },
    ...
    { type: 'cordova', content: capacitorCordovaContent29, name: 'Capacitor/Cordova' },
...
<RCCodeBlock tabs={[
    { type: 'swift', content: docsTesterSwift, name: 'Swift', region: "Getting the Product" },
...
For example, displaying a higher priced Offering to users that came from [paid acquisition](/docs/integrations/attribution) to help recover ad costs, or a specific Offering designed to show [iOS Subscription Offers](/docs/subscription-guidance/subscription-offers/ios-subscription-offers) when a user has [cancelled their subscription](/docs/customers/customer-info#section-get-entitlement-information). 
...
<RCCodeBlock tabs={[
    { type: 'swift', content: docsTesterSwift, name: 'Swift', region: 'Choosing which Offering to display' },
...
- Now that you've shown the correct products to users, time to [make a purchase ](/docs/getting-started/making-purchases)
- Check out our [sample apps ](/docs/platform-resources/sample-apps) for examples of how to display products.
