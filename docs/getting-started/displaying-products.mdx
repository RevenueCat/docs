...
import reactNativePlacementContent from "@site/code_blocks/tools/targeting_by_placement_4.js.txt?raw";
import flutterPlacementContent from "@site/code_blocks/tools/targeting_by_placement_5.dart?raw";
import capacitorPlacementContent from "@site/code_blocks/tools/targeting_by_placement_6.ts.txt?raw";
import unityPlacementContent from "@site/code_blocks/tools/targeting_by_placement_7.cs?raw";
import cordovaPlacementContent from "@site/code_blocks/tools/targeting_by_placement_8.ts.txt?raw";
...
<RCCodeBlock
  tabs={[
    ...
    { type: "flutter", content: flutterPlacementContent, name: "Flutter" },
    { type: "rn", content: reactNativePlacementContent, name: "React Native" },
    { type: "cordova", content: cordovaPlacementContent, name: "Cordova" },
    {
      type: "capacitor",
      content: capacitorPlacementContent,
      name: "Capacitor",
    },
    { type: "unity", content: unityPlacementContent, name: "Unity" },
  ]}
/>
