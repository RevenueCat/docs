...
- **Finish Transactions (optional)**: A boolean value to tell RevenueCat not to [finish transactions](/migrating-to-revenuecat/finishing-transactions). Only pass true if you have your own code handling purchases.
