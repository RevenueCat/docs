...
import kotlinChinaWorkaround from "!!raw-loader!@site/code_blocks/getting-started/configuring-sdk_3_china_url.kt";
import kmpChinaWorkaround from "!!raw-loader!@site/code_blocks/getting-started/configuring-sdk_10_kmp_china_url.kts";
...
If your app has a significant user base in mainland China, we recommend setting the `proxyURL` property before initializing the SDK. 
...
<RCCodeBlock tabs={[
    ...
    { type: 'kotlin', content: kmpChinaWorkaround, name: 'Kotlin Multiplatform' },
