...
**SDK Version Requirements:** Test Store requires minimum SDK versions (iOS 5.43.0, Android 9.9.0, Flutter 9.8.0, React Native 9.6.0, Capacitor 11.3.0, Cordova 7.2.0, Unity 8.3.0, KMP 2.3.0, Web 1.15.0). [See all versions](/test-and-launch/sandbox#testing-with-revenuecat-test-store).
:::
