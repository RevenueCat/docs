...
- **Finish Transactions (optional)**: A boolean value to tell _Purchases_ not to finish transactions [finish transactions](/migrating-to-revenuecat/finishing-transactions). Only pass true if you have your own code handling purchases.
...
If you're planning to use RevenueCat alongside your existing purchase code, make sure to disable [finishing transactions](/migrating-to-revenuecat/finishing-transactions).
