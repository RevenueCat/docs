...
hidden: false
---
If this is your first time integrating RevenueCat into your app, we recommend following our [Quickstart](/getting-started/getting-started) guide.
...
- **Observer Mode (optional)**: A boolean value to set _Purchases_ in [Observer Mode](/migrating-to-revenuecat/observer-mode). Only pass true if you're using RevenueCat for analytics purposes, and you're handling making purchases and checking subscription status yourself.
