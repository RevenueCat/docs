...
If you're planning to use RevenueCat alongside your existing purchase code, be sure to tell the SDK that [your app will complete the transactions](/migrating-to-revenuecat/sdk-or-not/finishing-transactions)
