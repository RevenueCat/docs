...
If you're planning to use RevenueCat alongside your existing purchase code, be sure to disable [finishing transactions](/migrating-to-revenuecat/sdk-or-not/finishing-transactions)
