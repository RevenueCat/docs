...
![Offerings Diagram](/images/getting-started/offerings_visual.png)
...
<Button href="/docs/paywalls/creating-paywalls">Create a Paywall →</Button>
<br />
<br />
...
Presenting a paywall varies depending on your platform. See [Displaying Paywalls](/paywalls/displaying-paywalls) to see in-depth examples for each platform.

<Button href="/docs/paywalls/displaying-paywalls">Present a Paywall →</Button>
<br />
<br />
