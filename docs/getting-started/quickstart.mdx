...
Each new RevenueCat project includes a Test Store provisioned automatically. This allows you to create products, configure entitlements and offerings, and test the complete purchase flow—all without connecting to the App Store or Google Play.

**Why start with Test Store:**

- ✅ **No platform accounts needed** - Skip Apple/Google setup during initial development
- ✅ **Instant setup** - Create products and test purchases in minutes
- ✅ **Full purchase flow testing** - Test paywalls, purchases, and subscription status in your app
- ✅ **Perfect for Expo and web** - Works in environments without native store APIs
- ✅ **Faster iteration** - Make changes and test without platform approval delays

<details>
  <summary>How Test Store works</summary>

The Test Store operates entirely within RevenueCat, letting you:

1. **Create test products** directly in the RevenueCat dashboard (no App Store Connect or Play Console needed)
2. **Configure entitlements and offerings** using these test products, just like real store products
3. **Design and test paywalls** with your test products
4. **Make test purchases** in your app that behave like real subscriptions
5. **Verify subscription status** and entitlement checks work correctly

Test Store purchases don't charge real money and don't interact with Apple or Google services. When you're ready for production, you'll connect your real store and swap in real products.

:::tip
Use Test Store during your development phase. Only connect to real stores when you're preparing for App Store/Play Store submission or need to test platform-specific features.
:::
...
After configuring your offerings (whether using Test Store or real store products), you can jump right into designing a paywall—even before installing the SDK! Just choose Paywalls in the sidebar of your project dashboard.
