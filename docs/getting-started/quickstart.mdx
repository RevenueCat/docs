...
- [Capacitor / Ionic Installation ](/getting-started/installation/capacitor)
...
import kmpContent2 from "!!raw-loader!@site/code_blocks/getting-started/getting-started_kmp_2.kts";
...
<body>
  ...
  <a
    href="https://github.com/RevenueCat/purchases-android/blob/main/examples/MagicWeather/app/src/main/java/com/revenuecat/sample/ui/paywall/PaywallFragment.kt#L60-L65"
    target="_blank"
    class="button-text"
  >
    Kotlin
...
import swiftContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_1.swift";
import objectiveCContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_2.m";
import kotlinContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_3.kt";
import javaContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_4.java";
import flutterContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_5.js";
import reactNativeContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_6.js";
import cordovaContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_7.js";
import capacitorContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_capacitor.ts";
import unityContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_8.cs";
import kmpContent3 from "!!raw-loader!@site/code_blocks/getting-started/making-purchases_kmp_1.kts";
...
<body>
  ...
  <a
    href="https://github.com/RevenueCat/purchases-android/blob/main/examples/MagicWeather/app/src/main/java/com/revenuecat/sample/ui/paywall/PaywallFragment.kt#L67-L79"
    target="_blank"
    class="button-text"
  >
    Kotlin
...
<body>
  ...
  <a
    href="https://github.com/RevenueCat/purchases-android/blob/main/examples/MagicWeather/app/src/main/java/com/revenuecat/sample/ui/user/UserFragment.kt#L81-L88"
    target="_blank"
    class="button-text"
  >
    Kotlin
  ...
  <a
    href="https://github.com/RevenueCat/purchases-flutter/blob/main/revenuecat_examples/MagicWeather/lib/src/views/user.dart#L93-L108"
    target="_blank"
    class="button-text"
  >
    Flutter
...
<body>
  <a
    href="https://github.com/RevenueCat/purchases-ios/blob/main/Examples/MagicWeather/MagicWeather/Sources/Lifecycle/AppDelegate.swift#L53-L59"
    target="_blank"
    class="button-text"
  >
    Swift
  ...
  <a
    href="https://github.com/RevenueCat/purchases-flutter/blob/main/revenuecat_examples/MagicWeather/lib/src/views/home.dart#L29-L42"
    target="_blank"
    class="button-text"
  >
    Flutter
