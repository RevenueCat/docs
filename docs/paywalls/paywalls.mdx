...
1. [Create a Paywall](/paywalls/creating-paywalls) on the Dashboard for the [Offering](/getting-started/entitlements) you intend to serve to your customers

2. See [displaying paywalls](/paywalls/displaying-paywalls) for how to display it into your app.
...
- Now that you know how our paywalls work, read about [creating paywalls](/paywalls/creating-paywalls)
- Once you're ready to see your paywalls in action, you can follow our guides on [displaying paywalls](/paywalls/displaying-paywalls)
