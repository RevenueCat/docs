...
:::warning App and Web configurations require admin or owner permissions
Developers cannot add app or web configurations as these actions require administrator or owner permissions.
:::
