...
If you've configured your project in the dashboard, it's time to create your Products and Paywalls.

//TODO: figure out what's the best doc to link from here.

<Button href="/docs/projects/connect-a-store">Creating Products →</Button>
