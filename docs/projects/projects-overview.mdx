...
3. If the project uses the [Apple Search Ads integration](/integrations/attribution/apple-search-ads#1-configure-integration), it will need to be reconfigured after the transfer
   :::
...
![transfer project menu](/docs_images/projects/transfer-project-menu.png)
