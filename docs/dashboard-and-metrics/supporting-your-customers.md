...
* _Cancel a subscription_ - If a subscription was purchased through Web Billing, you can also cancel that purchase from the RevenueCat dashboard. To cancel a subscription, click on the "..." menu on the subscription in the "Entitlements" card of the customer profile and then select "Cancel subscription". Learn more about managing subscriptions with Web Billing [here](/web/revenuecat-billing/managing-customer-subscriptions).
