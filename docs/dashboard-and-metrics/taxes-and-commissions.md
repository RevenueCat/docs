...
For more information on the App Store Small Business Program, [click here](/docs/platform-resources/apple-platform-resources/app-store-small-business-program).
...
For more information on Google’s reduced service fee for the first $1M in sales, [click here](/docs/platform-resources/google-platform-resources/15-reduced-service-fee).
...
To learn more about using integrations through RevenueCat, [click here](/docs/integrations/integrations).
...
To learn more about using our webhooks, [click here](/docs/integrations/webhooks).
...
To learn more about using our Scheduled Data Exports, [click here](/docs/integrations/scheduled-data-exports).
