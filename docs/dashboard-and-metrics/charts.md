...
Reconciling data between multiple sources is a fundamental challenge for all analytics systems. As a consequence, in-app purchase data from Apple, Google, or Stripe may not match what RevenueCat reports in Charts or in [Overview](/overview). Common reasons for these discrepancies are:
...
- [Active Subscriptions ](/active-subscriptions-chart)
- [Active Subscriptions Movement ](/active-subscriptions-movement-chart)
- [Churn ](/churn-chart)
- [Refund Rate ](/refund-rate-chart)
- [Annual Recurring Revenue (ARR) ](/annual-recurring-revenue-arr-chart)
- [Realized LTV per Customer ](/realized-ltv-per-customer-chart)
- [Realized LTV per Paying Customer ](/realized-ltv-per-paying-customer-chart)
- [Monthly Recurring Revenue (MRR) ](/monthly-recurring-revenue-mrr-chart)
- [Monthly Recurring Revenue Movement ](/monthly-recurring-revenue-movement-chart)
- [Revenue ](/revenue-chart)
- [Conversion to Paying ](/conversion-to-paying-chart)
- [Initial Conversion ](/initial-conversion-chart)
- [Trial Conversion ](/trial-conversion-chart)
- [Subscription Retention ](/subscription-retention-chart)
- [Active Trials ](/active-trials-chart)
- [Active Trials Movement ](/active-trials-movement-chart)
...
| Apple Search Ads Ad Group | If you're collecting [Apple Search Ads Attribution](/apple-search-ads), the specific ad group that drove the install (iOS only). |
| Apple Search Ads Campaign | If you're collecting [Apple Search Ads Attribution](/apple-search-ads), the specific campaign that drove the install (iOS only). |
...
- Learn how to view the purchase history of a specific user and grant them promotional access via the [Customer View ](/basic-information)
