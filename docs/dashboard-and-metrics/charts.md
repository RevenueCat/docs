...
Reconciling data between multiple sources is a fundamental challenge for all analytics systems. As a consequence, in-app purchase data from Apple, Google, or Stripe may not match what RevenueCat reports in Charts or in [Overview](/docs/overview). Common reasons for these discrepancies are:
...
- [Active Subscriptions ](/docs/active-subscriptions-chart)
- [Active Subscriptions Movement ](/docs/active-subscriptions-movement-chart)
- [Churn ](/docs/churn-chart)
- [Refund Rate ](/docs/refund-rate-chart)
- [Annual Recurring Revenue (ARR) ](/docs/annual-recurring-revenue-arr-chart)
- [Realized LTV per Customer ](/docs/realized-ltv-per-customer-chart)
- [Realized LTV per Paying Customer ](/docs/realized-ltv-per-paying-customer-chart)
- [Monthly Recurring Revenue (MRR) ](/docs/monthly-recurring-revenue-mrr-chart)
- [Monthly Recurring Revenue Movement ](/docs/monthly-recurring-revenue-movement-chart)
- [Revenue ](/docs/revenue-chart)
- [Conversion to Paying ](/docs/conversion-to-paying-chart)
- [Initial Conversion ](/docs/initial-conversion-chart)
- [Trial Conversion ](/docs/trial-conversion-chart)
- [Subscription Retention ](/docs/subscription-retention-chart)
- [Active Trials ](/docs/active-trials-chart)
- [Active Trials Movement ](/docs/active-trials-movement-chart)
...
| Apple Search Ads Ad Group | If you're collecting [Apple Search Ads Attribution](/docs/apple-search-ads), the specific ad group that drove the install (iOS only). |
| Apple Search Ads Campaign | If you're collecting [Apple Search Ads Attribution](/docs/apple-search-ads), the specific campaign that drove the install (iOS only). |
...
:::info
In order for RevenueCat to accurately track revenue for offer codes, you will need to upload an in-app purchase key. See our guide on [In-App Purchase Key Configuration](/docs/in-app-purchase-key-configuration) for step-by-step instructions.
:::
