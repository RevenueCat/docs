...
- [Active Subscriptions ](/docs/dashboard-and-metrics/charts/active-subscriptions-chart)
- [Active Subscriptions Movement ](/docs/dashboard-and-metrics/charts/active-subscriptions-movement-chart)
- [Churn ](/docs/dashboard-and-metrics/charts/churn-chart)
- [Refund Rate ](/docs/dashboard-and-metrics/charts/refund-rate-chart)
- [Annual Recurring Revenue (ARR) ](/docs/dashboard-and-metrics/charts/annual-recurring-revenue-arr-chart)
- [Realized LTV per Customer ](/docs/dashboard-and-metrics/charts/realized-ltv-per-customer-chart)
- [Realized LTV per Paying Customer ](/docs/dashboard-and-metrics/charts/realized-ltv-per-paying-customer-chart)
- [Monthly Recurring Revenue (MRR) ](/docs/dashboard-and-metrics/charts/monthly-recurring-revenue-mrr-chart)
- [Monthly Recurring Revenue Movement ](/docs/dashboard-and-metrics/charts/monthly-recurring-revenue-movement-chart)
- [Revenue ](/docs/dashboard-and-metrics/charts/revenue-chart)
- [Conversion to Paying ](/docs/dashboard-and-metrics/charts/conversion-to-paying-chart)
- [Initial Conversion ](/docs/dashboard-and-metrics/charts/initial-conversion-chart)
- [Trial Conversion ](/docs/dashboard-and-metrics/charts/trial-conversion-chart)
- [Subscription Retention ](/docs/dashboard-and-metrics/charts/subscription-retention-chart)
- [Active Trials ](/docs/dashboard-and-metrics/charts/active-trials-chart)
- [Active Trials Movement ](/docs/dashboard-and-metrics/charts/active-trials-movement-chart)
...
| Apple Search Ads Ad Group | If you're collecting [Apple Search Ads Attribution](/docs/integrations/attribution/apple-search-ads), the specific ad group that drove the install (iOS only). |
| Apple Search Ads Campaign | If you're collecting [Apple Search Ads Attribution](/docs/integrations/attribution/apple-search-ads), the specific campaign that drove the install (iOS only). |
...
:::info
In order for RevenueCat to accurately track revenue for offer codes, you will need to upload an in-app purchase key. See our guide on [In-App Purchase Key Configuration](/docs/service-credentials/itunesconnect-app-specific-shared-secret/in-app-purchase-key-configuration) for step-by-step instructions.
:::
