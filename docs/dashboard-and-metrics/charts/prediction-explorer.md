...
####  Other limitations
1. Stripe subscriptions may have worse prediction accuracy due to the fact that a single Stripe product may have transactions of multiple product durations, which makes survival curve modeling more complex. This is an area of focus during our beta to continue optimizing Stripe predictive performance.
