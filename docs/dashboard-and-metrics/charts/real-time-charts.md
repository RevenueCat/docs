...
At this time we support App Store, Play Store, Stripe and RevenueCat Web Billing apps are supported in Real-time Charts. Support Amazon, Roku, and Paddle is coming soon.
:::
