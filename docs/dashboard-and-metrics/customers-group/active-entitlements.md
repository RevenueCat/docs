...
The 'Entitlements' card gives you a quick glance at the current entitlement status for a user. You can see which product(s) or [Entitlement(s)](/entitlements) have been purchased, and when they'll renew or cancel.
...
You can manually [transfer entitlements](/restoring-purchases#transfer-purchases) from one customer to another via the dashboard.
