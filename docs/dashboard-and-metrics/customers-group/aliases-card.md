...
If this customer has any [aliases](/user-ids#aliasing), they will appear in the 'Aliases' sub-section.
...
:::info
If you see unexpected aliases, you may be incorrectly identifying users. See our [guide on App User Ids](/user-ids) for more information.
:::
