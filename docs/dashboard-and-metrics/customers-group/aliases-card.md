...
If this customer has any [aliases](/docs/user-ids#aliasing), they will appear in the 'Aliases' sub-section.
...
:::info
If you see unexpected aliases, you may be incorrectly identifying users. See our [guide on App User Ids](/docs/user-ids) for more information.
:::
