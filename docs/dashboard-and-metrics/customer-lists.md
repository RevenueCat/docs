...
For lists with the filter **Only Customers with Purchases** enabled (see our [Filters](/dashboard-and-metrics/customer-lists#filters) section below), deleted users will be removed in a matter of seconds. For lists without this filter, it will take up to 30 minutes for a deleted user to be removed.
:::
...
- Learn how to view the purchase history of a specific user and grant them promotional access via the [Customer View ➡️](/dashboard-and-metrics/customers-group/basic-information)
