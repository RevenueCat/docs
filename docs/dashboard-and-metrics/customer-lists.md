...
If a customer has a [Promotional](/promotionals) transaction, they are not considered as 'Active'. Note that if a customer has an active subscription + Promotional, they will not be counted in the Active Customer List.
...
For lists with the filter **Only Customers with Purchases** enabled (see our [Filters](/customer-lists#filters) section below), deleted users will be removed in a matter of seconds. For lists without this filter, it will take up to 30 minutes for a deleted user to be removed.
:::
...
| ------------------------------ | ------------ | -------------------------------------------------------------------------------------------------------------------------- |
| Ad                             | String       | The `$ad` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer.                                |
| Ad Group                       | String       | The `$adGroup` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer.                           |
| Auto Renew Intent              | Bool         | Whether the customer has opted out of auto-renew or not.                                                                   |
| Campaign                       | String       | The `$campaign` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer.                          |
...
| Creative                       | String       | The `$creative` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer.                          |
| Email                          | String       | The `$email` [Subscriber Attribute](/subscriber-attributes) for the customer.                                              |
...
| GPS Ad Id                      | String       | The `$gpsAdId` [Subscriber Attribute](/subscriber-attributes#device-identifiers) for the customer.                         |
| Granted RC Promotional         | Bool         | Whether the customer has been granted a [Promotional Subscription](/promotionals) or not.                                  |
| IDFA                           | String       | The `$idfa` [Subscriber Attribute](/subscriber-attributes#device-identifiers) for the customer.                            |
| IDFV                           | String       | The `$idfv` [Subscriber Attribute](/subscriber-attributes#device-identifiers) for the customer.                            |
| Keyword                        | String       | The `$keyword` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer.                           |
...
| Latest Entitlement             | String       | The latest [Entitlement](/entitlements) unlocked by the customer.                                                          |
| Latest Expiration Date         | Date         | The latest expiration date of the customer's [Entitlement](/entitlements).                                                 |
...
| Media Source                   | String       | The `$mediaSource` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer.                       |
| Number of Renewals             | Integer      | The total number of renewals the customer has had. A trial conversion is considered a renewal.                             |
| Phone Number                   | String       | The `$phoneNumber` [Subscriber Attribute](/subscriber-attributes) for the customer.                                        |
...
| Made Non-subscription Purchase | Bool         | Whether the customer has made any [non-subscription](/non-subscriptions) purchases or not.                                 |
...
| email | The `$email` [Subscriber Attribute](/subscriber-attributes) for the customer, if set. |
| phone_number | The `$phoneNumber` [Subscriber Attribute](/subscriber-attributes) for the customer, if set. |
| media_source | The `$mediaSource` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer, if set. |
| campaign | The `$campaign` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer, if set. |
| ad_group | The`$adGroup` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer, if set. |
| ad | The `$ad` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer, if set. |
| keyword | The `$keyword` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer, if set. |
| creative | The `$creative` [Subscriber Attribute](/subscriber-attributes#attribution-data) for the customer, if set. |
| idfa | The `$idfa` [Subscriber Attribute](/subscriber-attributes#device-identifiers) for the customer, if set. |
| idfv | The `$idfv` [Subscriber Attribute](/subscriber-attributes#device-identifiers) for the customer, if set. |
| gps_ad_id | The $gpsAdId [Subscriber Attribute](/subscriber-attributes#device-identifiers) for the customer, if set. |
| custom_attributes | JSON representation of any custom [Subscriber Attributes](/subscriber-attributes) set for the customer. |
...
- Learn how to view the purchase history of a specific user and grant them promotional access via the [Customer View ➡️](/basic-information)
