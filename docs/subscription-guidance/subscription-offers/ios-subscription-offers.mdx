...
Apple introduced win-back offers with iOS 18, which allow developers to provide custom pricing and trials to subscribers who have canceled a subscription and meet specific eligibility criteria set by the developer. Please see our page on [Apple Win-Back Offers](/subscription-guidance/subscription-offers/apple-subscription-offers/apple-win-back-offers) for more details, including implementation instructions. 