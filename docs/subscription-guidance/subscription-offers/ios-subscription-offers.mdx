...
| [Through Your App From a StoreKit Message](https://www.revenuecat.com/docs/subscription-guidance/subscription-offers/ios-subscription-offers#redeeming-a-win-back-offer-in-your-app-from-a-storekit-message)                   | ✅ Yes                   | Deferring when the message is displayed requires SDK version 5.6.0+                                                                    |
