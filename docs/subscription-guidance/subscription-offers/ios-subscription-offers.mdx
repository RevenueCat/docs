...
| Win-Back Offers        | Lapsed Users              | 🔑 Required                |                                                                                                                                                                                                                                                                                                                                                                                | ✅           |
...
Win-back offers can be configured in App Store Connect for subscription products that have been approved by Apple's App Review team. Navigate to your subscription's page under *Apps* → *Your App* → *Subscriptions* (in the left sidebar) → *Your Subscription Group* → *Your Subscription Product* and click the "+" button by "Subscription Prices". If your subscription product has been approved by App Review, you'll see the option "Create Win-Back Offer". Select it.
...
- Offer Priority: Determines if this win-back offer takes precedence over other offers available for its product ([More Info](https://developer.apple.com/help/app-store-connect/manage-subscriptions/set-up-win-back-offers))
- Customer Eligibility: Developer-provided eligibility criteria that determines whether a churned subscriber can purchase a win-back offer.
  ...
  - Time Since Last Subscribed: A time interval describing how long ago a subscriber must have been subscribed to the product to be eligible for the offer.
...
| Through Your App with PurchasesAreCompletedBy==MyApp       | ✅ Yes                   |                                                                                                         |
