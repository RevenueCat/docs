...
- **Customer Eligibility**: Developer-provided eligibility criteria that determines whether a churned subscriber can purchase a win-back offer.
  ...
  - _Wait Between Offers_: The required time a subscriber must wait after a win-back offer ends before redeeming the same offer again. Optional.
...
| [With a Custom Win-Back Offer URL](https://www.revenuecat.com/docs/subscription-guidance/subscription-offers/ios-subscription-offers#redeeming-a-win-back-offer-with-a-custom-win-back-offer-url)                                                     | Requires iOS SDK version 5.9.0+                                                                                                                   |
...
##### Redeeming a Win-Back Offer With a Custom Win-Back Offer URL
When you create a win-back offer in App Store Connect, Apple will generate a URL for the win-back offer. Eligible subscribers can use this URL to redeem the win-back offer in your app, and ineligible subscribers will not be able to use the URL to redeem the win-back offer. You can find the URL in the win-back offer's page in App Store Connect.
