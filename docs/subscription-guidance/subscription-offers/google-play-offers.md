...
On the following page, you can set up a unique offer ID, eligibility criteria, tags, and pricing phases. Tags can be used to [identify offers in the RevenueCat SDK](/subscription-offers#more-control-over-offer-selection).
...
With Promo Codes created make sure you're setup for [making purchases ➡️ ](/making-purchases)
