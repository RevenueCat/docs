...
import swift1 from "@site/code_blocks/subscription-guidance/subscription-offers_1.swift?raw";
...
import kt1 from "@site/code_blocks/subscription-guidance/subscription-offers_2.kt?raw";
