...
#### [PRODUCT_CHANGE](/dashboard-and-metrics/customer-history#event-types) events and webhooks
...
For Apple transactions,  prorated revenue **will not** be shown in the [Customer History](/dashboard-and-metrics/customer-history) page. However, prorated revenue **will** be calculated for your chart and overview data.

### Google Play

For Google transactions, prorated revenue will be shown in the [Customer History](/dashboard-and-metrics/customer-history) page and will be calculated for your chart and overview data.
