...
For information about Stripe, you can read more about working with web payments [here](/getting-started/stripe#working-with-web-payments).
...
In order to perform upgrades and downgrades for Google Play subscriptions, you will need to set the old product ID on `PurchaseParams.Builder`. Proration mode is optional and will default to `IMMEDIATE_WITH_TIME_PRORATION`.
...
#### [PRODUCT_CHANGE](/dashboard-and-metrics/customers-group/customer-history#event-types) events and webhooks
...
For Apple transactions,  prorated revenue **will not** be shown in the [Customer History](/dashboard-and-metrics/customers-group/customer-history) page. However, prorated revenue **will** be calculated for your chart and overview data.

### Google Play

For Google transactions, prorated revenue will be shown in the [Customer History](/dashboard-and-metrics/customers-group/customer-history) page and will be calculated for your chart and overview data.
