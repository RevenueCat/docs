...
Going forward, all iOS apps in RevenueCat will require you to upload your in-app purchase key configuration file. This should take you less than 5 minutes to complete. You can find instructions for where to find this file in our [documentation](/service-credentials/itunesconnect-app-specific-shared-secret/in-app-purchase-key-configuration).

### Observer Mode
If your app is using [observer mode](/migrating-to-revenuecat/observer-mode), there are a few steps you need to take when migrating to the new RevenueCat SDK backed by StoreKit 2.
