...
---
:::info
Read the migration blog post for more information about why we made the switch to supporting StoreKit 2 by default.
:::
...
### Observer Mode
If your app is using observer mode, there are a few steps you need to take when migrating to the new RevenueCat SDK backed by StoreKit 2.
...
- If you only support iOS 16+, follow Apple's guide to fetch these properties from `AppTransaction`
