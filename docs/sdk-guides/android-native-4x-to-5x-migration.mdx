...
There were various updates to our API in this release, in order to best support the Amazon Store and to maintain parity with our iOS SDK, which recently [migrated from ObjC to Swift](/ios-native-3x-to-4x-migration).
...
For more information about recommended identity logic following the removal of these identification methods, see [Identifying Users](/user-ids).
...
- Amazon support (see [the section in our docs for more information](/amazon-platform-resources))
