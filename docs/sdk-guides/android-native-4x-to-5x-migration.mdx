...
:::info
View the Android SDK Reference documentation [here →](https://sdk.revenuecat.com/android/index.html).
:::
...
import content1 from "@site/code_blocks/sdk-guides/android-native-4x-to-5x-migration_1.kt?raw";
import content2 from "@site/code_blocks/sdk-guides/android-native-4x-to-5x-migration_2.kt?raw";
