...
![Screen Shot 2023-01-12 at 11.44.20 AM.png](https://files.readme.io/3aede2a-Screen_Shot_2023-01-12_at_11.44.20_AM.png)
...
![Screen Shot 2023-01-12 at 5.06.34 PM.png](https://files.readme.io/fe78bbb-Screen_Shot_2023-01-12_at_5.06.34_PM.png)

### 2. Manual Import

For manual import, you need to add both your subscription ID and your base plan ID when adding a new product. 

![Screen Shot 2023-01-12 at 5.10.18 PM.png](https://files.readme.io/c8b5476-Screen_Shot_2023-01-12_at_5.10.18_PM.png)

You can find this information in Google Play Console here:

![Screen Shot 2023-01-12 at 5.07.03 PM.png](https://files.readme.io/9d0e770-Screen_Shot_2023-01-12_at_5.07.03_PM.png)

After you’ve added your products, you can assign them to packages the same as before. You can follow the documentation [here](/docs/getting-started/entitlements).  If you select a non backwards-compatible product and the [app compatibility setting](/docs/getting-started/entitlements/google-subscriptions-and-backwards-compatibility) is set to "SDK v6+ and backwards compatible", you will have the ability to configure a backwards compatible fallback product. This product will be available for purchase in previous versions of the SDK which don't yet support non backwards compatible products.
