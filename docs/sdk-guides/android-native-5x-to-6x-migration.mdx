...
![Screen Shot 2023-01-12 at 11.44.20 AM.png](/images/3aede2a-Screen_Shot_2023-01-12_at_11.44.20_AM_c3b0011010a68f46e17301664e3f8fec.png)
...
![](/images/8fa740d-Screen_Shot_2023-01-12_at_5.06.28_PM_743f6cff865ce69d877747bc57933311.png "Screen Shot 2023-01-12 at 5.06.28 PM.png")
...
![Screen Shot 2023-01-12 at 5.06.34 PM.png](/images/fe78bbb-Screen_Shot_2023-01-12_at_5.06.34_PM_046f3fc460ae78f5d3229a68c4a36bfa.png)

### 2. Manual Import

For manual import, you need to add both your subscription ID and your base plan ID when adding a new product. 

![Screen Shot 2023-01-12 at 5.10.18 PM.png](/images/c8b5476-Screen_Shot_2023-01-12_at_5.10.18_PM_c7be2f058954e8d6b7c8ffb08c06e3a2.png)
...
After you’ve added your products, you can assign them to packages the same as before. You can follow the documentation [here](/entitlements).  If you select a non backwards-compatible product and the [app compatibility setting](/google-subscriptions-and-backwards-compatibility) is set to "SDK v6+ and backwards compatible", you will have the ability to configure a backwards compatible fallback product. This product will be available for purchase in previous versions of the SDK which don't yet support non backwards compatible products.
