...
:::warning
Since subscriber attributes are writable using a [public key](/welcome/authentication) they should not be used for managing secure or sensitive information such as subscription status, coins, etc.
:::
...
Subscriber attributes are also included with transaction data for [Scheduled Data Exports](/integrations/scheduled-data-exports).
:::
