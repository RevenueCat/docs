...
<RCCodeBlock tabs={[
    ...
    { type: 'ts', content: webBillingContent, name: "Web (JS/TS)", region: "Check for specific entitlement" },
]}/>
...
<RCCodeBlock tabs={[
    ...
    { type: 'ts', content: webBillingContent, name: "Web (JS/TS)", region: "Check for any entitlement" },
]}/>
