...
App User IDs are case-sensitive, and are scoped to a whole Project. A user logged into the same App User ID on different platforms will be considered the same user, and access the entitlements they have purchased on any platform.
...
**ℹ️ App User IDs should be shorter than 100 characters**
