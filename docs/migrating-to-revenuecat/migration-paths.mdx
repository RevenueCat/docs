...
➡️ [Read more about how to determine whether or not you need the RevenueCat SDK](/migrating-to-revenuecat/sdk-or-not)
...
➡️ [Read more about how to import historical purchase data](/migrating-to-revenuecat/migrating-existing-subscriptions)