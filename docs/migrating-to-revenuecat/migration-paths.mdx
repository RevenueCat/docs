...
Get started with our [Connect to a Store](/projects/connect-to-a-store) guide to learn how to connect to a store and set up Server Notifications.
...
Do you have existing purchase code that you'd like to keep? No problem - RevenueCat can detect purchases made with your existing code, without needing to migrate your purchase logic. [Read more](/migrating-to-revenuecat/sdk-or-not/finishing-transactions) about how to finish transactions with your existing code.