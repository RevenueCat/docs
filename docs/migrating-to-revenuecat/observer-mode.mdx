...
![](/images/0925a4c-Receipt_Forwarding_Service_f3afcc5ec2e3de188219d44937583b73.png "Receipt Forwarding Service.png")
...
:::warning Past subscription history will not be imported for Google and Stripe subscriptions
...
#### 1. Configure the SDK
For the iOS SDK v5, we explicitly require you to select which StoreKit version your app is running on. The `storeKitVersion` parameter can be the following values:
- `.default` (this defaults to StoreKit 2)
- `.storeKit2`
- `.storeKit1`
