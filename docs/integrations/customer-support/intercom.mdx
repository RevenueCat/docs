...
title: Intercom
slug: intercom
excerpt: Display RevenueCat customer subscription data directly in your Intercom Support inbox
hidden: false
---
...
| :-----------: | :--------------------: | :---------------: | :---------------: | :-------------: |
| Intercom App  | RevenueCat → Intercom  |        ✅         |        ✅         |       ✅        |
...
1. Visit the [RevenueCat Customer Profiles app](https://www.intercom.com/app-store/) in the Intercom App Store
...
2. Find "RevenueCat Customer Profiles" in your installed apps, and pin it

![RevenueCat Customer Profiles app in Intercom sidebar](/docs_images/integrations/customer-support/intercom/intercom-sidebar-app.png)

**Verify Installation:**

1. Open any conversation in Intercom
2. Look for the RevenueCat app in the right sidebar under **Apps**
