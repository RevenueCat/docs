...
| Product Change           | rc_product_change_event        | rc_product_change_event A subscriber has changed the product of their subscription. This does not mean the new subscription is in effect immediately. See [Managing Subscriptions](/managing-subscriptions) for more details on updates, downgrades, and crossgrades.                                                                                                                          | ✅         | ✅          | ❌      | ✅      | ❌     |
...
![](/images/29eadd0-app.revenuecat.com_projects_85ff18c7_collaborators_1_d46182a24eda06bbc54da52a50e7cf2d.png)
...
![](/images/1046464-intercom_f32480d2c86a693778b943371daacc5c.png "intercom.png")
