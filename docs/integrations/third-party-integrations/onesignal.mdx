...
import onesignalV9ContentKotlin from "@site/code_blocks/integrations/third-party-integrations/onesignal_1.kt?raw";
import onesignalV9ContentReact from "@site/code_blocks/integrations/third-party-integrations/onesignal_1.ts?raw";
import onesignalV9ContentFlutter from "@site/code_blocks/integrations/third-party-integrations/onesignal_1.dart?raw";

<RCCodeBlock
  tabs={[
    { type: "swift", content: onesignalV9Content },
    { type: "kotlin", content: onesignalV9ContentKotlin },
    { type: "ts", title: "React Native", content: onesignalV9ContentReact },
    { type: "dart", title: "Flutter", content: onesignalV9ContentFlutter },
  ]}
/>
