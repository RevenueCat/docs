...
![Enable RevenueCat in Statsig integration page](https://files.readme.io/af93af9-enableStatSig.png)
...
![Statsig configuration page](https://files.readme.io/ceb1a77-app.revenuecat.com_projects_85ff18c7_integrations_intercom_4.png)
...
![Include Sandbox Events in Statsig integration page](https://files.readme.io/bbd8c17-enable_sandbox.png "enable_sandbox.png")
...
While still on the Customer View, select test purchase event in the [Customer History](/docs/dashboard-and-metrics/customers-group/customer-history) page and make sure that the Statsig integration event exists and was delivered successfully.
