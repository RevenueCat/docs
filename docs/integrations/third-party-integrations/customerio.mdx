...
The Customer.io integration is to all users signed up after September '23, the legacy Grow and Pro plans, and Enterprise plans. If you're on a legacy Free or Starter plan and want to access this integration, migrate to our new pricing via your [billing settings](https://app.revenuecat.com/settings/billing).
:::
...
2. Choose **Customer.io** from the Integrations menu
3. Add your Site ID and API key
4. Enter the event names that RevenueCat will send or choose the default event names
5. Select whether you want sales reported as gross revenue (before app store commission), or after store commission and/or estimated taxes.

![Customer.io configuration page](/images/customerio_integration_setup.png "Customer.io configuration page")
...
![Check that the Customer.io event was delivered](/images/customerio_event_details.png "Check that the Customer.io event was delivered")
...
![Check Customer.io Activity Logs](/images/customerio_activity_logs.png "Check Customer.io Activity Logs")

## Sample Events

Below are sample JSONs that are delivered to Customer.io for events.

import initialPurchaseContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/customerio_1.json";
import trialStartedContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/customerio_2.json";
import trialConvertedContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/customerio_3.json";
import trialCancelledContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/customerio_4.json";
import renewalContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/customerio_5.json";
import cancellationContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/customerio_6.json";
import uncancellationContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/customerio_7.json";
