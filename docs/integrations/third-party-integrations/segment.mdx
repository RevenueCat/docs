...
import kotlinContent from "@site/code_blocks/integrations/third-party-integrations/segment_1.kt?raw";
import reactContent from "@site/code_blocks/integrations/third-party-integrations/segment_1.ts?raw";
import flutterContent from "@site/code_blocks/integrations/third-party-integrations/segment_1.dart?raw";
