...
3. Add your Superwall Token (Superwall settings > Integrations). Note that you can configure a different server secret per platform if your app needs it.

Remember to select _Add Integration_

![](/images/superwall-integration.png)
