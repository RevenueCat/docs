...
While still on the Customer View, select the purchase event in the [Customer History](/docs/customer-history) page and make sure that the Superwall integration event exists and was delivered successfully.
