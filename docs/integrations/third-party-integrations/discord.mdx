...
| Cancellation               | Customer \<user_id> just cancelled their subscription of \<product_id> | A subscription or non-renewing purchase has been cancelled. See [cancellation reasons](/docs/integrations/webhooks/event-types-and-fields#cancellation-and-expiration-reasons) for more details.                                                               | ✅         | ✅          | ✅      | ✅      | ✅     |
