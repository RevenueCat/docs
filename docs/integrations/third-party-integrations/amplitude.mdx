...
import swiftContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/amplitude_1.swift";
...
If your App User ID in RevenueCat is different than the User ID in Amplitude, you can use the Amplitude User ID and/or Amplitude Device ID to identify events by adding a key in [Subscriber Attributes](/subscriber-attributes).
...
If both keys are present, RevenueCat will send both the User ID and Device ID to identify events into Amplitude. If only one of the keys are present, RevenueCat will only send the available key. If no keys are present, RevenueCat will send the current RevenueCat App User ID. This property can be set and removed manually, like any other [Subscriber Attribute](/subscriber-attributes). For more information how Amplitude tracks unique users, view their docs [here](https://help.amplitude.com/hc/en-us/articles/115003135607-Tracking-unique-users).
...
![](/images/0c37a59-app.revenuecat.com_projects_85ff18c7_collaborators_1_25dceedfa16cd1f509f0f596955530fa.png)
...
![Amplitude configuration page](/images/bb2663f-app.revenuecat.com_projects_85ff18c7_integrations_branch_7_d75336a6f81cf75614269c934a71fa18.png)
...
import initialPurchaseContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/amplitude_4.json";
import trialStartedContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/amplitude_5.json";
import trialConversionContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/amplitude_6.json";
import trialCancelledContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/amplitude_7.json";
import renewalContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/amplitude_8.json";
...
import expirationContent from "!!raw-loader!@site/code_blocks/integrations/third-party-integrations/amplitude_13.json";
