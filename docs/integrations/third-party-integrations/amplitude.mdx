...
Additionally, you can enable to track events for Funnels. These events are different from the events above as they will be triggered when an action happens in any of your funnels.

The events that are tracked for Funnels are:
| Event                     | Default Event Name                   | Description                                                                                                                                                                                                                                                                                                                                 |
| ------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Workflow step started     | rc_workflows_step_started_event      | A workflow step has started and customer was able to see it.                                                                                                                                                                                                                                                                                |
| Workflow step completed   | rc_workflows_step_completed_event    | A workflow step has been completed. This means a customer clicked in any button (or exited) the step.                                                                                                                                                                                                                                       |
| Workflow purchase         | rc_workflows_purchase_event          | A workflow purchase has been made. Please note this event is separated of purchase made in the app, and helps you track the performance of your funnel.                                                                                                                                                                                     |
...
import workflowsStepStartedContent from "@site/code_blocks/integrations/third-party-integrations/amplitude_16.json?raw";
import workflowsStepCompletedContent from "@site/code_blocks/integrations/third-party-integrations/amplitude_17.json?raw";
import workflowsPurchaseContent from "@site/code_blocks/integrations/third-party-integrations/amplitude_18.json?raw";
