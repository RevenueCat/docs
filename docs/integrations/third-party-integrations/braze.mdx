...
If you are looking to send an alternative unique user identifier that is different than your App User ID, update Customers with the below data as [Attributes](/customers/customers-attributes).
