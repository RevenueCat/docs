...
Events notify you in near real-time to any changes that occur to a customer's subscription and can automatically be sent into a variety of [third-party tools](/docs/third-party-integrations) and [attribution networks](/docs/attribution) to get clean, consistent, and trustworthy data in all of your systems.
...
2. Running any of the RevenueCat SDKs in [Observer Mode](/docs/observer-mode#option-2-client-side) will automatically collect this information.
