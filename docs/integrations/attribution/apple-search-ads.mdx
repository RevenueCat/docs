...
Apple Ads offer two products, **Apple Ads Basic** and **Apple Ads Advanced**. The RevenueCat Apple Ads integrations supports both Basic and Advanced. However, Advanced will require more configuration than Basic.
:::
...
- Navigate to your project in the RevenueCat dashboard and choose 'Apple Ads Services' from the Integrations menu.
- Click on **Add Apple Ads integration** to add the integration.
- Go to **Account Settings** > **API** in your Apple Ads dashboard, and paste your public key in the **Client Credentials** section in settings of your **API User**.
...
- Then, copy the provided `clientId`, `teamId` and `keyId` from the Apple Ads page to your RevenueCat Dashboard.
