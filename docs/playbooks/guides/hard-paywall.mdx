...
Offer different subscription types (e.g., Monthly, Annual, Lifetime), allowing users to choose from various options. For more information on how to set this up, please refer to our [product setup documentation](https://www.revenuecat.com/docs/offerings/products-overview).
