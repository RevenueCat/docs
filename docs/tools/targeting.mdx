...
:::warning
In December 2023 we began referring to a Project's current Offering as it's default Offering. Learn more [here](/docs/getting-started/displaying-products#fetching-offerings).
:::
...
![Create a new rule](https://files.readme.io/d499c34-Empty_State.png)
...
![Ready to save](https://files.readme.io/5fe8d9a-Create_a_New_Rule.png)
...
![Screenshot](https://files.readme.io/4b11583-Screenshot_2023-12-22_at_10.30.34_AM.png)
...
![Ordering](https://files.readme.io/403f610-Ordering_Rules.png)
...
![Rule actions](https://files.readme.io/292656b-Editing_Rules.png)
...
![When filtering by App version, select the App that the filter applies to first.](https://files.readme.io/bb9ce00-App_version_filter.png)
