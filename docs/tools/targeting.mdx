...
:::warning
In December 2023 we began referring to a Project's current Offering as it's default Offering. Learn more [here](/docs/displaying-products#fetching-offerings).
:::
