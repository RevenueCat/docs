...
![Our control paywall using default values](https://files.readme.io/05b8dd7-Color_Control.png)
...
![Paywall with an overridden English description](https://files.readme.io/2ae2213-Language_English.png)

Meanwhile, a user whose device is set to Spanish will see this variation.

![Paywall with an overridden Spanish description](https://files.readme.io/2f92b3f-Language_Spanish.png)
...
![Paywall with a discounted offering set and altered description for the promotional offerings](https://files.readme.io/007f9fe-With_Coupon.png)
