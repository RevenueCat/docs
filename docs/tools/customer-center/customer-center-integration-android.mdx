...
You can listen to Customer Center events in two ways: using a global listener that will be called for all Customer Center instances, or using a local listener through the CustomerCenter composable options.
