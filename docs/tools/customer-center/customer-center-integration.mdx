...
Cancellation Offers: For responses in the cancellation survey, the system will use a promotional offer labeled with the suffix rc_cancel_offer. RevenueCat will automatically look for and display this promotion if the offer id in App Store Connect ends with rc_cancel_offer.

Refund Offers: When a user requests a refund, RevenueCat will show the promotional offer with the suffix `rc_refund_offer` in the promotion offer id.
