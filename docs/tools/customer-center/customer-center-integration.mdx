...
Cancellation Offers: By default, for responses in the cancellation survey, RevenueCat will use a promotional offer where the id has the suffix `rc_cancel_offer`.
