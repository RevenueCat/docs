...
[Learn how to setup promotional offers in App Store Connect here.](/docs/subscription-guidance/subscription-offers/ios-subscription-offers#promotional-offers)

### Play Store

In a similar way, offers on the Play Store allow you to provide a custom price or a trial (or both) for a product. There are [different types of offers](/docs/subscription-guidance/subscription-offers/google-play-offers#eligibility-criteria) that can be created in the Play Store. For the Customer Center, you will be using the **Developer determined** type.
...
[Learn how to setup promotional offers in Google Play Console here.](/docs/subscription-guidance/subscription-offers/google-play-offers#promotional-offers)
...
You may also customize your configuration to provide other offers, or provide them when the user performs other actions. [Learn more about configuring the Customer Center.](/docs/tools/customer-center/customer-center-configuration)
