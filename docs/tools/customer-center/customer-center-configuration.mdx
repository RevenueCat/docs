...
2. **Management screen for users without an active subscription**: This screen is shown when the user doesn't have an active subscription. It typically only offers the option to restore purchases.
