...
In order for these promotional offers to be given to your customers, they must be first be created in App Store Connect. [Learn more.](https://www.revenuecat.com/docs/tools/customer-center-integration#setting-up-promotional-offers)
:::
...
The available paths, their feedback surveys, and all associated promotional offers can be customized through **Advanced configuration**. [Learn more.](https://www.revenuecat.com/docs/tools/customer-center-configuration#advanced-configuration)
