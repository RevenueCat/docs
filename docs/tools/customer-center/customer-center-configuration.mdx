...
|-----------------------------|---------------------------|
| ![Main Customer Center Screen](/docs_images/virtual_currency_balances_cc_main_screen.png) | ![Virtual Currencies Screen](/docs_images/customer-center/virtual_currency_balances_screen.png) |
