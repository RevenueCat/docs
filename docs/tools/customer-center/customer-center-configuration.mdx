...
In order for these promotional offers to be given to your customers, they must be first be created in App Store Connect and Google Play Console. [Learn more.](/docs/tools/customer-center/customer-center-integration#setting-up-promotional-offers)
:::
...
// TODO
![Customer Center Update Warning](/images/customer-center-update-warning.png)
...
// TODO
![Customer Center Purchase History](/images/customer-center-purchase-history.png)
...
:::warning Offers must be created in App Store Connect
In order for these promotional offers to be given to your customers, they must be first be created in App Store Connect. [Learn more.](/docs/tools/customer-center/customer-center-integration#setting-up-promotional-offers)
:::
...
- The product mapping is a map of store product identifiers to promotional offer identifiers. The promotional offer has to be created in App Store Connect before it can be used. [Learn more.](/docs/tools/customer-center/customer-center-integration#setting-up-promotional-offers) 
