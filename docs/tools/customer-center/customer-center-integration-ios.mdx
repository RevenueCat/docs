...
The CustomerCenterView can be integrated in a few different ways depending on how you want to present it within your app. Below are the supported options:

 The simplest way to present the CustomerCenterView is using a modal sheet:

 import usageViewSheet from "!!raw-loader!@site/code_blocks/tools/customer-center-usage-1-sheet.swift";
 ...
 import usageViewStack from "!!raw-loader!@site/code_blocks/tools/customer-center-usage-1-navigationstack.swift";
