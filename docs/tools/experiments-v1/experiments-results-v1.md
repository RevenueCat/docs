...
![Untitled (1).png](https://files.readme.io/2326dd9-Untitled_1.png)
...
[Learn more about MRR here.](/docs/dashboard-and-metrics/charts#monthly-recurring-revenue-mrr)
...
Our [Scheduled Data Exports](/docs/integrations/scheduled-data-exports) include the experiment enrollment of each subscriber in the reported transactions, and by subscribing to them you can receive daily exports of all of your transactions to analyze the experiment results further.
