...
1. How to start setting custom attributes
2. How to create Targeting Rules with custom attributes
3. How to sync custom attributes to serve fresh paywalls
...
import swiftContent1 from "!!raw-loader!@site/code_blocks/tools/targeting_by_custom_attributes_1.swift";
import kotlinContent2 from "!!raw-loader!@site/code_blocks/tools/targeting_by_custom_attributes_2.kt";
import javaContent3 from "!!raw-loader!@site/code_blocks/tools/targeting_by_custom_attributes_3.java";
