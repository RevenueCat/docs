...
![Add Placement](/docs_images/targeting/add-placement.png)
...
![Create a Placement](/docs_images/targeting/create-a-placement.png)
...
![Set a Placement for all other cases](/docs_images/targeting/for-all-other-cases.png)
...
![onboarding_end Placement](/docs_images/targeting/create-a-placement-highlighted.png)
...
import reactNativeContent4 from '@site/code_blocks/tools/targeting_by_placement_4.js.txt?raw';
import flutterContent5 from '@site/code_blocks/tools/targeting_by_placement_5.dart?raw';
import capacitorContent6 from '@site/code_blocks/tools/targeting_by_placement_6.ts.txt?raw';
import unityContent7 from '@site/code_blocks/tools/targeting_by_placement_7.cs?raw';
import webContent8 from '@site/code_blocks/tools/targeting_by_placement_8.ts.txt?raw';
