...
- You can use offering metadata together with [Offering Override](/dashboard-and-metrics/customer-history/offering-override) to display messaging for special offers and discounts. For example, you could create a key `discount_message` that, if present, shows a special message about the applied discount on the paywall, and set that on a discounted Offering that you apply as an override to customers who are eligible for the specific discount.
...
![Example response where metadata is used to control additional paywall variables](/images/febdc0b-Screen_Shot_2023-05-19_at_4.35.53_PM_06b85f9ec30299a571ecba3e435038de.png)

## How to add metadata to your Offering

First, navigate to the Offering you'd like to add metadata to and click **Edit**.

![No Metadata](/images/129070e-No_Metadata_a86cefc3a196c6040ae914914bb3552b.png)

Then begin adding valid JSON in the **Metadata** field for your Offering.

![Editing](/images/09d62d4-Editing_Final_93a4c5857c2ab08c8e7eb6c0d0f21a22.png)

Once you've entered your desired JSON object, click **Save** to save your changes.

![Saving](/images/3aec146-175995e-Saving_Final_12ca272df24dc12fa237138803272f97.png)
...
![Saved](/images/e434090-Saved_Final_acb416c7084413cab5e9860bc5a81e4d.png)
...
import content3 from "!!raw-loader!@site/code_blocks/tools/offering-metadata_3.dart";
import content4 from "!!raw-loader!@site/code_blocks/tools/offering-metadata_4.ts";
import content5 from "!!raw-loader!@site/code_blocks/tools/offering-metadata_5.ts";
