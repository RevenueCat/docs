...
![Add paywall](https://files.readme.io/9140485-Screenshot_2023-08-04_at_12.08.07.png)
...
1. [Create a Paywall](/docs/tools/paywalls/creating-paywalls) on the Dashboard for the [Offering](/docs/getting-started/entitlements) you intend to serve to your customers

2. See [displaying paywalls](/docs/tools/paywalls/displaying-paywalls) for how to display it into your app.
...
Paywalls in Android will use the default subscription option which, in case you use [developer determined offers](/docs/subscription-guidance/subscription-offers/google-play-offers#eligibility-criteria), will always be available, providing these types of offers always to your users. If you want to avoid this behavior when using paywalls, add the `rc-ignore-offer` tag to the developer determined offer from your product.

## Next Steps

* Now that you know how our paywalls work, read about [creating paywalls](/docs/tools/paywalls/creating-paywalls)
* Once you're ready to see your paywalls in action, you can follow our guides on [displaying paywalls](/docs/tools/paywalls/displaying-paywalls)
