...
If your app has user accounts or authentication, you can provide RevenueCat with custom App User IDs when configuring the SDK. This allows you to track users across devices and platforms.
