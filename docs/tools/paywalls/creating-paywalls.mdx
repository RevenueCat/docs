...
3. Importing from Figma ([Learn more](/tools/paywalls/creating-paywalls/importing-from-figma))
...
Your paywall designs must be using Figma Autolayout to be imported correctly.
:::

3. **Export to RevenueCat**:
   - Open the RevenueCat plugin from your Figma plugins menu
   - Select the frames you want to export
   - Authenticate with your RevenueCat account
...
| ✅     | **Button** (`button`)                               | `Button` or `Button(action=purchase)`                            |
| ✅     | **Package** (`package`)                             | `Package` (exact match)                                          |
| ✅     | **Purchase Button** (`purchase_button`)             | `Purchase Button` (exact match)                                  |
| ✅     | **Input Single Choice** (`input_single_choice`)     | `InputSingleChoice(field_id=my_field)`                           |
| ✅     | **Input Option** (`input_option`)                   | `InputOption(option_id=my_option)`                               |
...
| ❌     | **Input Multiple Choice** (`input_multiple_choice`) | Not supported                                                    |
