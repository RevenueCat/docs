...
Exit offers allow you to present an alternative offer when a user dismisses your paywall without making a purchase. This can help recover potentially lost conversions by giving users a second chance to subscribe, with a different offer. For a complete, end-to-end guide on implementing this strategy, see our [Exit Offers Playbook](/playbooks/guides/exit-offers).
