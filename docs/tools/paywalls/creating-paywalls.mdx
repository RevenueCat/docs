...
![Products and pricing](https://files.readme.io/73e1721-Products_and_pricing.png)

Then, click **+ Add paywall** next to the Offering that you want to create a Paywall for.

![Add paywall](https://files.readme.io/5dba69c-Add_pricing.png)
...
![Screenshot](https://files.readme.io/c53fb56-Screenshot_2023-08-31_at_3.51.13_PM.png)
