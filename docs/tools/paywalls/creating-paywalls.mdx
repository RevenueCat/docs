...
:::tip
If you’re looking to experiment with a new paywall, consider duplicating your default Offering and attaching your new paywall to the duplicated Offering. Duplicating an Offering with a paywall attach will also duplicate the paywall.
:::
...
To prevent this, you may use [Targetting](/tools/targeting) to control who can see a paywall with a newer variable.
