...
Once configured, the exit offer will automatically be presented when users dismiss the paywall without purchasing, as long as you're using a supported presentation method.
