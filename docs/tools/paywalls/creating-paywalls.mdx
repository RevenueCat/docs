...
These docs refer to our original Paywalls. We've recently released our beta of Paywalls v2, a brand new paywall builder for designing custom layouts. If you're interested in exploring that beta, [click here](/tools/paywalls-v2/creating-paywalls).
:::
