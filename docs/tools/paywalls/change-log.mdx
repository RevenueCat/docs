...
| Date | Description |
| :----------------- | :---------- |
| June 6, 2025 | [SDK versions]: Paywalls are now out of beta. |
| June 6, 2025 | iOS 5.26.1: Fixed a bug causing some image components to extend beyond the width of the device in some conditions. |
