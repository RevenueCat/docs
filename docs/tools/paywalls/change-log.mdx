...
| Date | Description |
| :----------------- | :---------- |
| October 17, 2025 | iOS 5.42.0, Android 8.25.0: Added the Video component, allowing you to upload and display videos on your paywalls. [Learn more](https://www.revenuecat.com/docs/tools/paywalls/creating-paywalls/components#video-component) |
| October 17, 2025 | Added support for buttons to open a sheet that can be used to display additional content, like a "View all plans" button. [Learn more](https://www.revenuecat.com/docs/tools/paywalls/creating-paywalls/components#navigate-to-sheet) |
