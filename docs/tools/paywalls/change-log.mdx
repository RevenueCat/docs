...
| Date | Description |
| :----------------- | :---------- |
| October 3, 2025 | Added support for buttons to open a sheet that can be used to display additional content, like a "View all plans" button. [Learn more](https://www.revenuecat.com/docs/tools/paywalls/creating-paywalls/components#navigate-to-sheet) |
