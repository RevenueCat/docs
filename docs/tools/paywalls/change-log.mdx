...
| Date | Description |
| :----------------- | :---------- |
| September 12, 2025 | iOS 5.39.0: Added support for native macOS paywalls and improved image caching for instant image loading when displaying paywall |
| September 8, 2025 | iOS 5.37.0, Android 8.24.0, React Native 9.4.0: Set preferred locale for paywalls to display with |
