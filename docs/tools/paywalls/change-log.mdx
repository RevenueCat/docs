...
| Date | Description |
| :----------------- | :---------- |
| January 12, 2026 | Figma import documentation moved to its own section and updated with implementation details for all currently supported components. [Learn more](https://www.revenuecat.com/docs/tools/paywalls/creating-paywalls/importing-from-figma) |
