...
| November 14, 2025 | iOS 5.48.0, Android 9.14.0: Added the Countdown component. [Learn more](https://www.revenuecat.com/docs/tools/paywalls/creating-paywalls/components#countdown-component) |
