...
| Date | Description |
| :----------------- | :---------- |
| October 17, 2025 | iOS 5.44.1, Android 8.25.0: Added the Video component, allowing you to upload and display videos on your paywalls. [Learn more](https://www.revenuecat.com/docs/tools/paywalls/creating-paywalls/components#video-component) |
