...
| Date | Description |
| :----------------- | :---------- |
| December 2025 | Added validation for button action types when importing from Figma. Invalid action types now default to `navigate_back` to prevent paywall validation errors. [Learn more](https://www.revenuecat.com/docs/tools/paywalls/creating-paywalls#importing-from-figma) |
