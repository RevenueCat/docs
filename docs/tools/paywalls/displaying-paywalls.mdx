...
Paywalls are supported on the web through RevenueCat's Web Billing system. To serve your Paywall to customers on the web via a new or exiting Web Purchase Link, [click here](https://www.revenuecat.com/docs/web/web-billing/paywalls).

:::info Web SDK support coming soon
We're currently working on adding support for web paywalls in the [purchases-js SDK]https://www.revenuecat.com/docs/web/web-billing/web-sdk). Stay tuned!
:::

:::info Max width
Paywalls on the web have a maximum width of 968px. If the window the paywall is being displayed in is wider than 968px, the additional space will be filled based on the specified background color of your checkout config. [Learn more](https://www.revenuecat.com/docs/web/web-billing/web-purchase-links)
