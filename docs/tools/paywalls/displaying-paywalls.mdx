...
import preferredLocaleFlutter from '@site/code_blocks/tools/paywalls_preferred_locale_4.dart?raw';
import preferredLocaleCapacitor from '@site/code_blocks/tools/paywalls_preferred_locale_5.ts.txt?raw';

<RCCodeBlock tabs={[
    {
        type: 'swift',
        title: "iOS",
        content: preferredLocaleSwift,
    },
    {
        type: 'kotlin',
        title: "Android",
        content: preferredLocaleKotlin,
    },
    {
        type: 'rn',
        title: "React Native",
        content: preferredLocaleReactNative,
    },
    {
        type: 'flutter',
        title: "Flutter",
        content: preferredLocaleFlutter,
    },
    {
        type: 'capacitor',
        title: "Capacitor",
        content: preferredLocaleCapacitor,
    },
]}/>
...
import customVarsRNPresent from '@site/code_blocks/tools/paywalls_custom_variables_1.ts.txt?raw';
import customVarsRNView from '@site/code_blocks/tools/paywalls_custom_variables_2.ts.txt?raw';

<RCCodeBlock
  tabs={[
    { type: "rn", title: "presentPaywall", content: customVarsRNPresent },
    { type: "rn", title: "Paywall", content: customVarsRNView }
  ]}
/>

### Flutter

import customVarsFlutterPresent from '@site/code_blocks/tools/paywalls_custom_variables_1.dart?raw';
import customVarsFlutterView from '@site/code_blocks/tools/paywalls_custom_variables_2.dart?raw';

<RCCodeBlock
  tabs={[
    { type: "flutter", title: "presentPaywall", content: customVarsFlutterPresent },
    { type: "flutter", title: "PaywallView", content: customVarsFlutterView }
  ]}
/>
...
Exit offers allow you to present an alternative offer when a user dismisses your paywall without making a purchase. This is a powerful tool for recovering potentially lost conversions by giving users a second chance to subscribe with a different offer, such as a discounted price or alternative package. For a complete, end-to-end guide on implementing this strategy, see our [Exit Offers Playbook](/playbooks/guides/exit-offers).
