...
To control which customers see that offer, then, consider using Targeting; where you can modify which paywall is shown to different customer audiences by Custom Attributes, different paywall Placements, and more. [Learn more](/docs/tools/targeting).
:::
