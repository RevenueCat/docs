...
### Fallback stack
If you're serving a paywall with a Countdown component on SDK version that do not support, we recommend enabling the fallback stack for the component so you can customize exactly what you'd like to display in its place.
