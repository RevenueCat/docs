...
The video component supports MP4, MOV, and AVI upload formats; and converts all uploaded videos to MP4 for the best compatibility on mobile devices.
...
2. **Progressive loading**: The video file is downloaded progressively, allowing playback to begin before the entire file is downloaded.
