...
## Express checkout and Wallet

The Express Checkout component allows you to offer quick purchase buttons like Apple Pay and Google Pay directly on your web paywall.

[Learn more about Express checkout and the Wallet component.](/tools/paywalls/creating-paywalls/express-checkout)
