...
![Font modal](/images/paywalls-font-modal.png)
...
:::info Improving font loading performance
You can reduce loading times and improve performance on Android by adding the font to your app's resources. Click the three horizontal dots to the left of the upload button in the font modal to open the modal for specifying each font family's resource name.
:::
