...
The switch component allows you to add a toggle to your paywall that can be used to let customers between two different sets of options. Switches are frequently used to offer a set of packages that do/don't offer a free trial, do/don't offer family sharing, etc.
