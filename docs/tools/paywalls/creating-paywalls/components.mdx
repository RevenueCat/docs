...
In addition to being added as their own component, videos can also be used as a background for your paywall, footer, or any parent component that supports a `Fill` being added.
:::
