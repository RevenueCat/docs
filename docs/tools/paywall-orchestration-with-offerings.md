...
We recommend displaying the **Current Offering** for a given customer on your paywall to ensure you can take advantage of all the remote flexibility of Offerings, which you can learn how to do [here](/docs/getting-started/displaying-products#fetching-offerings).
...
:::info [Learn more about Experiments](/docs/tools/experiments-v1)
:::
...
:::info [Learn more about Targeting](/docs/tools/targeting)
:::
...
:::info [Learn more about Offering Metadata](/docs/tools/offering-metadata)
:::
