...
Authentication steps allow you to redirect users to your own authentication system (Firebase Auth, Auth0, custom backend, etc.) and bring them back to the funnel once they've logged in. This is useful when you need users to authenticate before proceeding to checkout or accessing certain content.

To add an authentication step:

1. Click **Add page** in the left sidebar
2. Select **Authentication**
3. Configure your **External authentication URL**

Once added, the authentication step will appear as a node in your funnel flow. When users reach this step, they'll be redirected to your authentication system and returned to the funnel after successful login.
