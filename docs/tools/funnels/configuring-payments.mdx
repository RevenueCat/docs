...
After creating the app, you'll see your **Public API Key** and **Sandbox API Key**. These are used for testing and production environments.
...
:::info Offerings and checkout steps
When you add a checkout step to your funnel, it uses the Offering settings from your funnel configuration. Make sure your funnel is associated with the correct Offering that contains your Web Billing products.
:::
...
Once you have the basics set up, you can optionally configure:

- **Multi-currency support**: Offer products in multiple currencies
- **Localization**: Translate your purchase flow
- **Payment methods**: Enable Google Pay, Apple Pay, and other payment options
- **Tax collection**: Set up Stripe Tax for automatic tax calculation
- **Custom metadata**: Pass custom data with purchases

See [Configure Web Billing](/web/web-billing/configuring-overview) for a complete list of configuration options.
