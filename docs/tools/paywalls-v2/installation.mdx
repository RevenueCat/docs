...
These docs refer to our beta of Paywalls v2. For installation requirements of original Paywalls, [click here](/tools/paywalls/installation).
:::
...
![Configure version](/images/paywalls-check-version.png)
