...
:::warning
Web Purchase Buttons are only supported on the App Store, and are only permissible in the US according to the latest App Store Guidelines. To serve distinct paywalls on iOS and Android, we recommend using [Targeting](https://www.revenuecat.com/docs/tools/targeting).
:::
