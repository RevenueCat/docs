...
Stacks, carousels, packages, buttons, and the footer are all complex components which can contain other components within them.
:::
...
[Learn more about setting custom fonts.](/tools/paywalls-v2/displaying-paywalls#custom-fonts)
...
The earliest beta versions of our iOS SDK do not support the carousel component. Update to at least 5.18.0 to use this component, though we recommend updating to the latest version to get all fixes and improvements related to the carousel.
:::
...
We're already working on additional components that will be supported in the near future to support things like multi-tier paywalls and trial toggles. Have a component in mind you want to see added? [Let us know about it!](https://form.typeform.com/to/Fuamg1Er)
