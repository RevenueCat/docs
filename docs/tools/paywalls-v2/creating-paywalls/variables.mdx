...
## Variable modifiers
Our SDKs support a handful of modifiers that can be used to format the variable values:
...
:::info Dashboard support
The dashboard currently does not support previewing the variable modifiers, but that support will be coming soon.
:::
