...
<YouTubeEmbed videoId="HbF-5tpaBzc" title="Empty Offerings Explanation & Troubleshooting" />
...
- [Web Billing](https://www.revenuecat.com/docs/web/revenuecat-billing) - Since Web Billing supports using Stripe as the payment gateway, we currently will use the same supported countries as Stripe does as seen in the link above.
