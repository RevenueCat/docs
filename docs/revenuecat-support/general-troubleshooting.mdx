...
:::info You can delete the hard-coded user at any time that you see it pop up in the dashboard (This might happen since some users may be slower to update the app). :::

### Can I reset customer attributes? 
While you can't directly reset customer attributes, you can delete your current attribute by passing null or an empty string as the key value. Once you do this you will have to call restorePurchases or syncPurchases to trigger an update to the cahce. Individual attributes can also be cleared for a specific user in their customer view. Once you do this, you will be able to set these attributes to whatever they need to be set to effectively resetting them. 
