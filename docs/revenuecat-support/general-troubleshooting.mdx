...
- Note: You can delete the hard-coded user at any time that you see it pop up in the dashboard (This might happen since some users may be slower to update the app). 
