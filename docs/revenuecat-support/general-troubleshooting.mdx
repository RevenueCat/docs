...
### Seeing crashes like `NoClassDefFoundError: com.android.billingclient.api.zzce` in your android app?
...
This issue was introduced by Google in the Billing client library in version 7.1.+. It has been reported [here](https://issuetracker.google.com/issues/377466571) and [here](https://issuetracker.google.com/issues/404645683).
...
Until they fix this, the current workaround is to enable Core Library Desugaring in your Android app. To do so, you can follow the instructions [here](https://developer.android.com/studio/write/java8-support#library-desugaring). 
