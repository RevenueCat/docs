...
import om7 from "@site/code_blocks/migrating-to-revenuecat/observer-mode_7.cs?raw";
import om8 from "@site/code_blocks/migrating-to-revenuecat/observer-mode_8.kt?raw";
