...
|  Stripe  | One-time purchases supported when using [Stripe Checkout](/stripe) |
...
For more information, read our guide on [Entitlements](/entitlements).
...
![](/images/e7cd1c4-app.revenuecat.com_projects_85ff18c7_apps_app71b4cc0fea_1_f34fb380d07f0a0a38041d469963d8f5.png)
...
![](/images/0f1a9b6-app.revenuecat.com_projects_85ff18c7_apps_app71b4cc0fea_2_54e481fc14f9ba136c0ec58a9e2c5a0c.png)

:::info
If you haven't already, you'll need to set up products in the respective app stores on which you intend to ship your app. For more information on setting up products and adding them to RevenueCat, check out the [Configuring Products](/entitlements#configuration) guide.
:::
...
For more information displaying products, check out the [Displaying Products](/displaying-products) guide.
...
:::warning
It's important to note that at the moment, logic for keeping track of consumable redemptions must be handled outside of RevenueCat. We recommend your server is set up to receive [Webhook](/webhooks) events for `NON_RENEWING_PURCHASE` to appropriately provide consumable content for your users.
...
For more information on making purchases, check out the [Making Purchases](/making-purchases) guide.
