...
### Tracking new purchases using Apple Real-Time Server Notifications
...
* The subscriber app user ID will be taken from the `appAccountToken` field of the transaction
