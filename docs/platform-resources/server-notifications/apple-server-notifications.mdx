...
:::warning
If you have enabled [*Keep with original App User ID*](/getting-started/restoring-purchases#keep-with-original-app-user-id) transfer behavior or are exclusively using custom app user IDs, we highly recommend turning this setting off unless you are not setting the `appAccountToken`.
:::