...
As of January 1, 2022, [all Google Play subscription transactions](https://support.google.com/googleplay/android-developer/answer/112622?hl=en) are calculated using a 15% service fee, regardless of how much revenue a developer earns in one year. This is automatically reflected in RevenueCat metrics and events.

For non-subscription, one-time purchases, the 15% service fee applies to the first $1,000,000 USD of earnings each year. Once your earnings cross this threshold in a calendar year, the service fee for non-subscription products increases to 30%.
