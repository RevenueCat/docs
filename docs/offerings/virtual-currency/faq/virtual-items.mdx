...
If your app has a small and fixed set of virtual items, you can represent each item as its own virtual currency. Note that RevenueCat has a limit of 100 virtual currencies per project that can be configured.
