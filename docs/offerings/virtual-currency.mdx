...
import fetchVCBalancesPurchasesJS from "@site/code_blocks/virtual-currency/vc-balance-sdk-js.txt?raw";
...
import cachedVirtualCurrenciesPurchasesJS from "@site/code_blocks/virtual-currency/cached-virtual-currencies-js.txt?raw";
