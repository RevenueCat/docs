...
You can display a user their currenct virtual currency balances in RevenueCat's [Customer Center](/tools/customer-center/customer-center-configuration#virtual-currencies). Please refer to this section of the Customer Center configuration guide for more information on displaying virtual currencies in the Customer Center.
