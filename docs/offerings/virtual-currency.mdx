...
You can display a user's virtual currency balances in RevenueCat's [Customer Center](/tools/customer-center/). Please refer to [this section](/tools/customer-center/customer-center-configuration#virtual-currencies) of the Customer Center configuration guide for more information on displaying virtual currencies in the Customer Center.
