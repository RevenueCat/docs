...
### Limitations
The maximum amount of a single virtual currency that a user can own must be between 0 and 2,147,483,647 (2³¹ - 1). Negative balances are currently not supported.
