...
import reactNativeRedemption from "@site/code_blocks/web/web-billing/redemption_react.txt?raw";
...
import capacitorRedemption from "@site/code_blocks/web/web-billing/redemption_capacitor.txt?raw";
