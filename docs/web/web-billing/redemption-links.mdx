...
1. The Web Billing purchase flow is initialized, either through the web SDK `purchase()` method, or through a [Web Paywall Link](/web/web-billing/web-paywall-links) (App User ID not required at this stage)
