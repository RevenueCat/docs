...
- RevenueCat Web Billing: supported ✅ (requires Stripe account for payment gateway)
- Paddle Billing: supported ✅ (requires Paddle account)
- Stripe Billing: not yet supported ❌
...
To start using Web Billing, you will need to add a Web Billing platform to your project. To do that, go to **Apps & providers** and add a new _Web Billing_ web config to your project.
