...
- We do not collect the customer's name or billing/shipping address. Consequently, Web Billing cannot be used in India and in other countries that have this requirement.
