...
Sales tax & VAT support in Web Billing is currently a beta feature. Please check the [limitations](#current-limitations) below before enabling it.
:::
...
- **Existing subscriptions not affected** — enabling tax collection will only apply tax rates to new subscriptions purchased after the feature was enabled. Renewals for existing subscriptions that were active before tax collection was enabled will not have taxes calculated or applied.
