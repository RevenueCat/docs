...
OOnce your setup is complete, you will receive two links formatted as `https://pay.rev.cat/<someProductionTokenWeGenerate>/<yourAppUserId>` (one for production, the other one for sandbox).
