...
When customers open your Web Purchase Link, they land on a product selection page. You can choose from two options for this page:

- Show the default product selection page (has lightweight customization and branding options)
- A paywall (fully customizable using RevenueCat's [paywall builder](../../tools/paywalls/creating-paywalls); has parity with mobile paywalls)

#### Configuring the default product selection page
...
#### Configuring a paywall as the product selection page
