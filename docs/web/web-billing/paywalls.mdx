...
You can use [RevenueCat Paywalls](../../tools/paywalls) as part of a web purchase flow, either in a (hosted) Web Purchase Link, or from the Web SDK. RevenueCat's Paywalls allow you to remotely configure your entire paywall UI without any code changes.
...
When using a paywall on web, you should expect it to be displayed in a greater variety of screen widths. You can use the tablet layout views in the editor to ensure users have a better experience on larger screens.
...
1. Edit the web purchase link, and change the **Paywall** dropdown to use your custom paywall:

![Paywall dropdown](/docs_images/web/web-billing/web-purchase-link-paywall-selection.png)

_Note: if this dropdown isn't visible, your offering most likely doesn't have a paywall created in it._
...
:::warning required SDK version
In order to present a paywall from the Web SDK, you must be using version xxx.xxx or later.
:::

You can see how to integrate the Web SDK [here](../web-billing/web-sdk).
