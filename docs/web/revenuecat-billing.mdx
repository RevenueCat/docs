...
Web Billing (formerly RevenueCat Billing) and the Web SDK allow you to easily offer web subscriptions. It utilizes Stripe as the payment gateway. This means you will need to set up and [connect your Stripe account](/web/connect-stripe-account) to RevenueCat.

Web Billing differs from our [Stripe Billing / Stripe Checkout](/web/stripe) integration in that it takes care of the purchase UI, the subscription management portal, and the recurring billing logic. Stripe will still charge a [payment processing fee](https://stripe.com/pricing) if you use Web Billing, but you will not have to pay [Stripe Billing / Checkout fees](https://stripe.com/billing/pricing).
...
To start using Web Billing, you will need to add a Web Billing App to your project. To do that, go the project settings, and in the "Apps" section, click "New", then "Web Billing":

![New Web Billing App](/images/web-billing/new-web-billing-app.png)
...
- **Default Currency**: The default currency to use for the prices of the products. [Read more about multi-currency support in Web Billing](/web/revenuecat-billing/multi-currency-support).
...
![New Web Billing App](/images/web-billing/new-web-billing-app-form.png)
...
Both anonymous and identified customers are supported by the SDK and by the [Web Paywall Links](/web/revenuecat-billing/web-paywall-links).
