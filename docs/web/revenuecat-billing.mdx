...
RevenueCat Billing and the Web SDK allow you to easily offer web subscriptions. RevenueCat Billing utilizes Stripe as the payment gateway. This means you will need to set up and [connect your Stripe account](/web/connect-stripe-account) to RevenueCat. 

RevenueCat Billing differs from our [Stripe Billing / Stripe Checkout](/web/stripe) integration in that RevenueCat Billing takes care of the purchase UI, the subscription management portal, and the recurring billing logic. Stripe will still charge a [payment processing fee](https://stripe.com/pricing) if you use RevenueCat Billing, but you will not have to pay [Stripe Billing / Checkout fees](https://stripe.com/billing/pricing).
