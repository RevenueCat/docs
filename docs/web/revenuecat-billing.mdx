...
Sandbox subscriptions renew faster than actual subscriptions to facilitate testing. They also automatically renew up to a maximum of 6 cycles. At that point, the subscription will be automatically cancelled.
...
| Subscription duration | 5 minutes and up to 6 cycles          |
