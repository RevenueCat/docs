...
- **Default Currency**: The default currency to use for the prices of the products. [Read more about multi-currency support in RevenueCat Billing](./multi-currency-support).
