...
![](/images/rc-billing/web-paywall-link-choose-returning-customers.png)
...
To use these links, you will need to **append the App User ID of the customer** ([URL encoded](https://www.w3schools.com/tags/ref_urlencode.ASP)) you want to be able to subscribe from the link. Without appending the app user ID, the link will not work.
...
want to reach with this link. You can read more about this requirement [here](/web/revenuecat-billing#identifying-customers).
:::
...
:::info
Please ensure all URL parameters are [URL encoded](https://www.urlencoder.org/).
:::