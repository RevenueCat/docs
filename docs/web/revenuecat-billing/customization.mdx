...
title: Customization
slug: customization
excerpt: Customizing RevenueCat Billing and the purchase flow
hidden: false
---
The appearance of certain elements of the RevenueCat Billing experience can be customized to match your app's branding. This includes the colors and shapes of certain UI elements.
...
To customize the appearance of the RevenueCat Billing experience, go to the App settings in the RevenueCat dashboard and navigate to the **Appearance** tab. You can configure the following options there:

* **Page background**: Used for the background of the page for [Web Paywall Links](/web/revenuecat-billing/customer-portal.mdx).
...
![](/images/rc-billing/customization.png)