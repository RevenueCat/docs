...
- Some of the supported languages may have minor translation issues, and we're working to validate them (please [contact us]("mailto:support@revenuecat.com") or [open an issue](https://github.com/RevenueCat/purchases-js/issues) in our github repo with any corrections or general feedback on translations).
