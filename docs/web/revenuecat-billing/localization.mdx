...
- RevenueCat Billing currently supports language localization in the Web SDK, with support for 33 languages.
...
- Localization of prices is handled through [multi-currency support](/web/revenuecat-billing/multi-currency-support/); you should configure this separately.
