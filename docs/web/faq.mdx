...
Add a new app in your RevenueCat project and select **Web Billing** as the payment provider. RevenueCat also supports the web payment flow using Web Billing directly in RevenueCat [Paywalls v2](/tools/paywalls-v2).
