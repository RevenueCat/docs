...
Web Billing differs from our [Stripe Billing](/web/stripe) integration in that it takes care of the purchase UI, the subscription management portal, and the recurring billing logic.
