...
Your app is finally complete! 🎉 You're tracking subscriptions in Sandbox, your Testflight users love it, you've followed our [Launch Checklist](/docs/test-and-launch/launch-checklist), and you're finally ready to launch your app to the world.
...
![Don't forget to submit the products with the first version of your app containing in-app purchases](https://files.readme.io/bec1d0d-Screen_Shot_2020-06-10_at_1.17.23_PM.png)
...
![Make sure any in-app purchases you intend to use are "Ready to Submit".](https://files.readme.io/e823df0-Screen_Shot_2020-06-10_at_1.33.58_PM.png)
...
If an error occurs during the purchase process, it will be one of the errors outlined in our [Error Handling guide here](/docs/test-and-launch/errors). Understanding what error triggered the rejection is the only way to make sure the issue gets resolved. 
...
This is actually the generic error message Apple uses for all [SKErrors](https://developer.apple.com/documentation/storekit/skerror) and not an error message from RevenueCat. See our [guide on Error Handling](/docs/test-and-launch/errors) for more info.
...
Double check that you're [checking the subscription status correctly](/docs/customers/customer-info) and all of the [products are added to Entitlements](/docs/getting-started/entitlements) as needed.
