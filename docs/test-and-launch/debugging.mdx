...
:::tip
This section assumes you've followed our [Quickstart](/quickstart) section of our Getting Started guide to install and configure our SDK.
:::
...
| ------- | --------- | ------------------------------------------------ | ----------------------------------------------------- |
| 🍎 ‼️   | Error     | Error/warning messages generated from Apple      | View [error handling doc](/errors) if on Error level |
| 🤖 ‼️   | Error     | Error/warning messages generated from Google     | View [error handling doc](/errors) if on Error level |
| 📦 ‼️   | Error     | Error/warning messages generated from Amazon     | View [error handling doc](/errors) if on Error level |
| 😿 ‼️   | Error     | Error messages generated from RevenueCat         | View [error handling doc](/errors)                  |
...
- If you spotted any errors while debugging, make sure you're [handling errors correctly ](/errors)
- You've verified that _Purchases_ is running correctly, time to start [making purchases in sandbox ](/sandbox)
