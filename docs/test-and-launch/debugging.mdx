...
| ------- | --------- | ------------------------------------------------ | ----------------------------------------------------- |
| 🍎 ‼️   | Error     | Error/warning messages generated from Apple      | View [error handling doc](doc:errors) if on Error level |
| 🤖 ‼️   | Error     | Error/warning messages generated from Google     | View [error handling doc](doc:errors) if on Error level |
| 📦 ‼️   | Error     | Error/warning messages generated from Amazon     | View [error handling doc](doc:errors) if on Error level |
| 😿 ‼️   | Error     | Error messages generated from RevenueCat         | View [error handling doc](doc:errors)                  |
