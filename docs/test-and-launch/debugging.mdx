...
:::tip
This section assumes you've followed our [Quickstart](/docs/getting-started/getting-started) section of our Getting Started guide to install and configure our SDK.
:::
...
import db1 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_1.swift";
import db2 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_2.m";
import db3 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_3.kt";
import db4 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_4.java";
import db5 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_5.js";
import db6 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_6.js";
import db7 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_7.js";
import db8 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_8.js";
import db9 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_9.js";
...
![RevenueCat iOS Debug UI](https://files.readme.io/03f4de1-simulator_screenshot_0e51e44b-dd33-41f6-9c26-ca3bed754b34.png)

import db10 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_9.swift";
import db11 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_10.swift";

{/* TODO - Need better code block handling for SwiftUI vs UIKit examples */}
<RCCodeBlock tabs={[
    {
        type: 'swiftui',
        content: db10,
...
| ------- | --------- | ------------------------------------------------ | ----------------------------------------------------- |
| 🍎 ‼️   | Error     | Error/warning messages generated from Apple      | View [error handling doc](/docs/test-and-launch/errors) if on Error level |
| 🤖 ‼️   | Error     | Error/warning messages generated from Google     | View [error handling doc](/docs/test-and-launch/errors) if on Error level |
| 📦 ‼️   | Error     | Error/warning messages generated from Amazon     | View [error handling doc](/docs/test-and-launch/errors) if on Error level |
| 😿 ‼️   | Error     | Error messages generated from RevenueCat         | View [error handling doc](/docs/test-and-launch/errors)                  |
...
import db14 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_11.txt";
import db15 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging_12.txt";
...
- If you spotted any errors while debugging, make sure you're [handling errors correctly ](/docs/test-and-launch/errors)
- You've verified that _Purchases_ is running correctly, time to start [making purchases in sandbox ](/docs/test-and-launch/sandbox)
