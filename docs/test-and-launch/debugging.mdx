...
With the RevenueCat SDK's, you can set a custom log handler for redirecting our debug logs to your own logging system. By default, this sends info, warning, and error messages. You can enable this by setting the `logHandler` property. You can set this immediately in your app while testing, **before you configure Purchases**.

import lh1 from "!!raw-loader!@site/code_blocks/test-and-launch/logHandler_1.swift";
import lh2 from "!!raw-loader!@site/code_blocks/test-and-launch/logHandler_2.m";
import lh3 from "!!raw-loader!@site/code_blocks/test-and-launch/logHandler_3.kt";
import lh4 from "!!raw-loader!@site/code_blocks/test-and-launch/logHandler_4.java";
import lh5 from "!!raw-loader!@site/code_blocks/test-and-launch/logHandler_5.js";
import lh6 from "!!raw-loader!@site/code_blocks/test-and-launch/logHandler_6.js";
import lh7 from "!!raw-loader!@site/code_blocks/test-and-launch/logHandler_7.js";
import lh8 from "!!raw-loader!@site/code_blocks/test-and-launch/logHandler_8.js";
import lh9 from "!!raw-loader!@site/code_blocks/test-and-launch/logHandler_9.js";
