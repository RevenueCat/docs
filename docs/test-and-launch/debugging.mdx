...
| ------- | --------- | ------------------------------------------------ | ----------------------------------------------------- |
| 🍎 ‼️   | Error     | Error/warning messages generated from Apple      | View [error handling doc](/docs/errors) if on Error level |
| 🤖 ‼️   | Error     | Error/warning messages generated from Google     | View [error handling doc](/docs/errors) if on Error level |
| 📦 ‼️   | Error     | Error/warning messages generated from Amazon     | View [error handling doc](/docs/errors) if on Error level |
| 😿 ‼️   | Error     | Error messages generated from RevenueCat         | View [error handling doc](/docs/errors)                  |
...
- If you spotted any errors while debugging, make sure you're [handling errors correctly ](/docs/errors)
- You've verified that _Purchases_ is running correctly, time to start [making purchases in sandbox ](/docs/sandbox)
