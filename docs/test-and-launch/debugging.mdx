...
:::tip
This section assumes you've followed our [Quickstart](/getting-started/getting-started) section of our Getting Started guide to install and configure our SDK.
:::
