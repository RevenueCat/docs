...
**Preconditions:**
_ The RevenueCat SDK is integrated into the app.
_ Offerings are configured in the RevenueCat dashboard. \* The app's paywalls are set up to display offerings and packages.
...
- [Subscription Lifecycle](https://www.revenuecat.com/docs/web/revenuecat-billing/subscription-lifecycle)
...
- [Free Trials](https://www.revenuecat.com/docs/web/revenuecat-billing/subscription-lifecycle#free-trials)
...
- [Managing Customer Subscriptions](https://www.revenuecat.com/docs/web/revenuecat-billing/managing-customer-subscriptions)
