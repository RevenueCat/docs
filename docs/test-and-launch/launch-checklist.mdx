...
|-----------------------------------------------------------------------------------|-----|---------|
| Before releasing, make sure that all agreements and tax forms have been signed and that banking information has been added as this is required to fetch products correctly.  | ✅ | ✅ |
