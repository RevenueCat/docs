...
:::info IAPs During App Review
In-app purchases **will work during in Sandbox and TestFlight as long as they have the status "Ready to Submit"** before your app is approved. Apple reviewers can test and purchase your IAPs as part of their review. You do not need to wait for approval for IAPs to function during review.
:::

However, if the app has never been released on the App Store, it must be **publicly released** before in-app purchases will work in production for your users.
