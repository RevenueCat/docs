...
Using a Test Store API key in production will prevent real purchases from working. See [Configuring SDK](/getting-started/configuring-sdk#switching-between-test-store-and-real-stores) for details on managing API keys across environments.
:::
