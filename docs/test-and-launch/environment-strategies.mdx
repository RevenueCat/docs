...
**Bundle ID Customization:** You may choose to use different bundle IDs corresponding to separate apps for each environment. While all apps will be uploaded to the App Store Connect or Google Play, these separate apps should stay unreleased with only the PROD app released into production.
