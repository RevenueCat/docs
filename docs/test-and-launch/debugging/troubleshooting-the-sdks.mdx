...
Make sure that you're using the latest version of the SDK for your platform, and have installed the SDK according to our [Installation](/docs/getting-started/installation) guides. 
...
2. If you're using XCFrameworks with Carthage, make sure you [follow our installation guide](/docs/getting-started/installation/ios#carthage-with-xcframeworks). 
...
4. Follow the [troubleshooting steps for iOS](/docs/test-and-launch/debugging/troubleshooting-the-sdks#ios).
...
- **"Purchases / PurchasesHybridCommon required a higher minimum deployment target":** see [troubleshooting steps for iOS](/docs/test-and-launch/debugging/troubleshooting-the-sdks#ios). 
- **"ld: symbol(s) not found for architecture x86_64":** see [troubleshooting steps for iOS](/docs/test-and-launch/debugging/troubleshooting-the-sdks#ios). 
- **"declaration of 'RCPurchases' must be imported from module 'Purchases' before it is required":** see [troubleshooting steps for iOS](/docs/test-and-launch/debugging/troubleshooting-the-sdks#ios). 
- **"Module 'Purchases' not found":** see [troubleshooting steps for iOS](/docs/test-and-launch/debugging/troubleshooting-the-sdks#ios).
