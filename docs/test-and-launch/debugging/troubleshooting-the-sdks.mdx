...
Make sure that you're using the latest version of the SDK for your platform, and have installed the SDK according to our [Installation](/installation) guides. 
...
![](/images/d483907-Screen_Shot_2021-05-03_at_3.28.13_PM_003993a8853c27043bafaf2fdab57045.png "Screen Shot 2021-05-03 at 3.28.13 PM.png")
...
![](/images/263088397-48938fb6-40bd-436b-a17f-dcf715524531_926b8e6f6b0cbea262e093b0d9130851.png "Module Verifier")
...
![](/images/43c42c6-Screen_Shot_2021-05-03_at_3.43.57_PM_a8e96ff2e0bb64ed659f30bae58b4ed0.png "Screen Shot 2021-05-03 at 3.43.57 PM.png")
...
2. If you're using XCFrameworks with Carthage, make sure you [follow our installation guide](/installation/ios#carthage-with-xcframeworks). 
...
4. Follow the [troubleshooting steps for iOS](/troubleshooting-the-sdks#ios).
...
import ts1 from "!!raw-loader!@site/code_blocks/test-and-launch/debugging/troubleshooting-the-sdks_1.ruby";
...
- **"Purchases / PurchasesHybridCommon required a higher minimum deployment target":** see [troubleshooting steps for iOS](/troubleshooting-the-sdks#ios). 
- **"ld: symbol(s) not found for architecture x86_64":** see [troubleshooting steps for iOS](/troubleshooting-the-sdks#ios). 
- **"declaration of 'RCPurchases' must be imported from module 'Purchases' before it is required":** see [troubleshooting steps for iOS](/troubleshooting-the-sdks#ios). 
- **"Module 'Purchases' not found":** see [troubleshooting steps for iOS](/troubleshooting-the-sdks#ios).
