...
![Image](https://files.readme.io/94582cb-small-Untitled.png)
...
For faster `CustomerInfo` updates, we recommend enabling [Platform Server Notifications](/docs/platform-resources/server-notifications) and the `CustomerInfo` [listener](/docs/getting-started/configuring-sdk#advanced-configuration). 
