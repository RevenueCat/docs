...
For faster `CustomerInfo` updates, we recommend enabling [Platform Server Notifications](/server-notifications) and the `CustomerInfo` [listener](/configuring-sdk#advanced-configuration). 
