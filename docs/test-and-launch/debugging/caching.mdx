...
For faster `CustomerInfo` updates, we recommend enabling [Platform Server Notifications](/docs/server-notifications) and the `CustomerInfo` [listener](/docs/configuring-sdk#advanced-configuration). 
