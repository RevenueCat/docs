...
| Framework  | Required Credentials       | Use Case                       | Purpose                                                  |
| ---------- | -------------------------- | ------------------------------ | -------------------------------------------------------- |
| StoreKit 2 | In-App Purchase Key        | iOS 15+, RevenueCat SDK v5.0+  | Server-to-server API, modern validation & management     |
| StoreKit 1 | App-Specific Shared Secret | iOS 15 or earlier, legacy apps | Server-side receipt validation & subscription management |
