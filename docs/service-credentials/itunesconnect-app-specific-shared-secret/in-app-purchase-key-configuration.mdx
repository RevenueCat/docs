...
RevenueCat will be able to give you the most accurate pricing and country-specific data for your Apple transactions. 

Please note that once you upload this key, we may update your historical data. As a result, you may see an increased number of updated transactions reported in your [Scheduled Data Exports](/integrations/scheduled-data-exports) and your historical [Charts](/dashboard-and-metrics/charts) data may also gradually update. 

## Setup

### 1. Generating an In-App Purchase Key

In-app purchase keys are generated App Store Connect under _Users and Access → Integrations → In-App Purchase_. You can use the same in-app purchase key for all of your App Store apps.
