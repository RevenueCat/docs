...
In-app purchase keys are generated App Store Connect under _Users and Access → Integrations → In-App Purchase_. You can use the same in-app purchase key for all App Store apps belonging to the same App Store Connect account.

![](/images/SCR-20240327-jvrs.png)
...
![](/images/55a58f1-Screenshot_at_Feb_01_11-51-45_84b8441cc70b005e4d68ade246fcc386.png)
...
![](/images/inapppurchase-settings.png)
...
![](/images/SCR-20240327-jygo.png)

![](/images/inapppurchase-issuerid.png)
...
![In-app purchase credential validator](/images/inapppurchase-credential-validator.png)
...
![Active in-app purchase key](/images/inapppurchase-active.png)
...
![Revoked in-app purchase key](/images/inapppurchase-revoked.png)
