...
In-app purchase keys are generated App Store Connect under _Users and Access → Integrations → In-App Purchase_. You can use the same in-app purchase key for all of your offers.
