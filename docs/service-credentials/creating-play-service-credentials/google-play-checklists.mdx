...
- [ ] I have invited my newly created service account in the **Users and Permissions** section
- [ ] I clicked **'Account Permissions'** under the service account and added these permissions:
