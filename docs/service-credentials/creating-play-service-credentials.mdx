...
![Google Cloud Console](https://files.readme.io/7706775-Crede_Step2aaaa.gif)
...
![Google Cloud Console](https://files.readme.io/a6896be-Crede_Step2b.gif)
...
![RevenueCat Dashboard](https://files.readme.io/c0354f7-Crede_Step4.gif)
...
:::tip
While you’re in your RevenueCat Play Store App settings and waiting for your credentials to activate, set up your [Google Real-Time Developer Notifications](/docs/platform-resources/server-notifications/google-server-notifications). If you enabled Pub/Sub in Step 2 of this doc, skip ahead to [step 2](/docs/platform-resources/server-notifications/google-server-notifications#2-choose-a-pubsub-topic-id) of the setup.
:::
...
- Manage orders and subscriptions in [step 3a](/docs/service-credentials/creating-play-service-credentials#a-grant-the-following-permissions)
- Once this is done, try to make a test purchase using a [Sandbox user](/docs/test-and-launch/sandbox/google-play-store) in order to check if the connection to the subscriptions API is working. 
...
This guide contains a lot of information and many steps, and it can be all too easy to move too quickly or simply misconfigure something. Break down each step by where it needs to take place as you're going through the guide or after the fact with our handy [Checklist](/docs/service-credentials/creating-play-service-credentials/google-play-checklists).
